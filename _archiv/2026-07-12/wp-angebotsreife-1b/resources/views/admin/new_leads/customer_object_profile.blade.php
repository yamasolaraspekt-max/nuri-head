                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-md-3 customer-div">
                                        ...
                                        <a href="{{ url('new_lead_details_edit/' . $customer->id)}}"><i
                ...
                <div id="card_preview">
                    <div class="row">
                        <div class="col-md-4 col-sm-3 ">
                            <div class="card mb-1" style="justify-self: flex-start;">
                                <div class="card-header p-1">
                                    <div class="col-5">
                                        <p style="font-size: 12px;font-weight: bold; margin-bottom:0; position:absolute">
                                            <a href="{{ url('new_lead_edit/' . $customer->id . '/' . $alternative->id)}}"><i
                                                    class="feather icon-edit primary"></i></a>
                                            {{ strtoupper($alternative->object_name) }}
                                        </p>
                                        <p style="font-size: 11px;font-weight: bold; margin-top:14px;"> <small>
                                                {{ $alternative->street }} {{ $alternative->postcode }} -
                                                {{ $alternative->city }}
                                            </small></p>
                                    </div>
                                    <div class="col-7" style="text-align: center">
                                        ...
                                        @if ($firstImage)
                                            <div class="col-12">
                                                ...
                                                <img src="{{ asset('images/customers/' . $firstImage->image) }}" alt="" class=""
                                                    style="width: 130px; cursor: pointer;" data-toggle="modal"
                                                    data-backdrop="false" data-target="#imageModal{{$alternative->id}}">
                                            </div>

                                            <div class="modal fade text-left" id="imageModal{{$alternative->id}}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            @foreach ($filteredScreenshots as $profile)
                                                                <img src="{{ asset('images/customers/' . $profile->image) }}" alt=""
                                                                    class="img-fluid m-2 gallery-image"
                                ...
                                <div class="card-content" style="">
                                                            ...
                                                            <div class="accordion-default collapse-bordered">
                                                                <div class="card collapse-header">
                                                                    ...
                                                                    @foreach ($product_list->where('customer_id', $customer->id)->where('alternative_id', $alternative->id)->unique(fn($product) => $product->product_id . '-' . $product->alternative_id) as $product)
                                                                        ...
                                                                        @endphp
                                                                        <div id="heading1"
                                                                            class="card-header collapse-header collapsed"
                                                                            data-toggle="collapse" role="button"
                                                                            data-target="#accordion{{$product->product_id}}"
                                                                            aria-expanded="false"
                                                                            aria-controls="accordion{{$product->product_id}}">
                                                                                ...
                                                                                <div class="title-product"
                                                                                    ...
                                                                                    <div class="status">
                                                                                        ...
                                                                                        @elseif($alternative->stage == 'plan')
                                                                                            <img src=" {{ asset('images/dashboard/icon_gears.svg') }}"
                                                                                                alt="" class="p-0"
                                                                                                style="width: 52px;">
                                                                                        @elseif($alternative->stage == 'offer')
                                                                                            <img src=" {{ asset('images/dashboard/icon_document.svg') }}"
                                                                                                alt="" class="p-0"
                                                                                                style="width: 52px;">
                                                                                        @elseif($alternative->stage == 'deal')
                                                                                            <img src=" {{ asset('images/dashboard/icon_memoboard.svg') }}"
                                                                                                alt="" class="p-0"
                                                                                                style="width: 52px;">
                                                                                        ...
                                                                                        @elseif($alternative->stage == 'end')
                                                                                            <img src=" {{ asset('images/dashboard/icon_target.svg') }}"
                                                                                                alt="" class="p-0"
                                                                                                style="width: 52px;">
                                                                                        @elseif($p_status == 'end')
                                                                        ...
                                                                        <div id="accordion{{$product->product_id}}"
                                                                            role="tabpanel" data-parent="#accordionWrapa1"
                                                                            ...
                                                                            <div class="card-content">
                                                                                <div class="card-body">
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li class="nav-item">
                                                                                            <a class="nav-link d-flex files"
                                                                                                id="files"
                                                                                                data-id="{{$alternative->id}}"
                                                                                                data-service="{{ $product->service }}"
                                                                                                data-initial="{{ $product->initial }}"
                                                                                        ...
                                                                                        <li class="nav-item">
                                                                                            <a class="nav-link d-flex  energy-link"
                                                                                                id="energe"
                                                                                                data-id="{{$alternative->id}}"
                                                                                                data-alternative="{{$alternative->id}}"
                                                                                                data-customer="{{$customer->id}}"
                                                                                        ...
                                                                                        <li class="nav-item">
                                                                                            <a class="nav-link d-flex "
                                                                                                id="account-pill-connections"
                                                                                                data-toggle="pill"
                                                                                                href="#account-vertical-connections"
                                                                                                aria-expanded="false">
                                                                                                Historie
                                                                                            </a>
                                                                                        </li>
                                                        ...
                                                        <td class="p-0 text-left ">
                                                            @foreach ($problems->where('problem_id', $ticket->id) as $problem)
                                                                <p style="font-size: 12px; margin:0;">
                                                                    {{ $problem->problem_types }},</p>
                                                            @endforeach
                                                        </td>
                                                        <td class="p-0">
                                                            <img src=" {{ asset('images/dashboard/icon_speechbubbles.svg') }}"
                                    ...
                                    <div class="row">
                                        <button type="button" data-toggle="modal"
                                            data-target="#delete-alter{{$alternative->id}}"
                                            class="btn btn-outline-primary square ml-2 mb-1 waves-effect waves-light">Löschen</button>
                                    </div>
                                    <!-- Edit Buttons  -->
                                    <div class="modal fade" id="delete-alter{{$alternative->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>Die Datensatznummer lautet:{{$customer->customer_no}}.
                                                        {{ $customer->name }} {{ $customer->lastname }} </p>
                                                    <p>Die Objektname: {{$alternative->object_name}}</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <a type="button"
                                                        href="{{url('/delete_lead_alternative') . '/' . $alternative->id}}"
                        ...
                        <!-- Display Part start  -->
                        <div class="col-md-8 display_part">
                            <div class="card" id="energie" data-id="" style="display: none;">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group row form-element">
                                                    ...
                                                    <div class="col-md-12 flex_me">
                                                        <label
                                                            id="heating_type">{{ $customer->heating_type ?? 'N/A' }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <p class="primary"><strong>STROMVERBRAUCH</strong></p>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <p class="primary"><strong>HEIZENERGIE VERBRAUCH</strong></p>
                                            </div>

                                            <div class="col-12">
                                                <div class="form-group row form-element">
                                                    <div class="col-md-12">
                                                        <p class="bold">Wie hoch ist Ihr jährlicher Verbrauch an
                                                            Heizenergie?</p>
                                                    </div>
                                                    <div class="col-md-12 flex_me">
                                            ...
                                            <!-- E-Mobilität Section -->
                                            <div class="col-12">
                                                <p class="primary"><strong>E-MOBILITÄT</strong></p>
                                            </div>

                                            <div class="col-12">
                                                <div class="form-group row form-element">
                                                    <div class="col-md-12">
                                                        <p class="bold">Haben Sie ein Elektroauto? Oder planen Sie, welche
                                                            zukaufen?</p>
                                                    </div>
                                    ...
                                    <button type="button"
                                        class="btn btn-flat-primary mr-1 mb-1 waves-effect waves-light edit_energy"
                                        data-toggle="modal" data-target="#editenergy">
                                        Bearbeiten
                                    </button>
                                    <div class="modal fade text-left" id="editenergy" tabindex="-1" role="dialog"
                                        aria-labelledby="myModalLabel17" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel17">ENERGIEVERBRAUCH &
                                                        OBJEKTDATEN</h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                ...
                                                <form action="{{ route('lead.info.data') }}" method="post">
                                                        ...
                                                        <div class="row" style="    background: white;">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welche Objektart handelt es
                                                                                sich?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <select name="objective" id=""
                                                                                class="form-control">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wieveil Wohneinheit hat das
                                                                                Obejekt?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wieviel Geschoß hat das Objekt?
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number" class="form-control"
                                                                                name="number_stories" value="">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wie groß ist die Beheizte
                                                                                Wohnfläche?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number" class="form-control"
                                                                                name="living_space" value="">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wieviel Personen wohnen in
                                                                                diesem Objekt?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number" class="form-control"
                                                                ...
                                                                <div class="col-12">
                                                                    <p class="primary"><strong>DACH-INFORMATION</strong>
                                                                        </h2>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welche Art vom Dach haben Sie?
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <select class="form-control form-element"
                                                                                name="roof_type" id="roof">
                                                                                <option selected></option>
                                                                                <option value="Satteldach">Satteldach
                                                                                </option>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        ...
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                                class="form-control form-element"
                                                                                name="roof_age" id="roof_age" value="" />
                                                                            <span
                                                                                style="position: absolute; right: 20px;">Jahr</span>

                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <span id="roof_age_error"
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welche Dacheindeckung hat das
                                                                                Dach?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="text" class="form-control textbox"
                                                                                name="tile_name" value="">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welche dachneigung hat ihr Dach?
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                                class="form-control textbox"
                                                                                name="roof_pitch" value="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welche himmelsausrechtung hat
                                                                                ihr Dach?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <select name="roof_direction" id=""
                                                                                class="form-control">
                                                                                <option value="south">Süden </option>
                                                                                <option value="south-west">Süd-west
                                                                                </option>
                                                                                <option value="west">Westen </option>
                                                                                <option value="north-west">Nord-west
                                                                                </option>
                                                                                <option value="north">Norden </option>
                                                                                <option value="north-east">Nord-ost
                                                                                </option>
                                                                                <option value="east">Osten </option>
                                                                                <option value="south-east">Süd-ost </option>
                                                                                <option value="east-west">Ost-West</option>
                                                                                <option value="north-south">Nord-Süd
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="col-12">
                                                                    <p class="primary"><strong>HEIZUNGS-INFORMATION</strong>
                                                                        </h2>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welche Art von Heizungsanlage
                                                                                haben Sie?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <select class="form-control form-element"
                                                                                name="heating_system_type"
                                                                                id="heating_system_type_edit">
                                                                                <option selected disabled> </option>
                                                                                <option value="Gas">Gas</option>
                                                                                <option value="Öl">Öl</option>
                                                                                <option value="Wärmepumpe">Wärmepumpe
                                                                                </option>
                                                                                <option value="Nachtspeicher">Nachtspeicher
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wie alt ist Ihre Heizungsanlage?
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                                ...
                                                                                id="heating_system_age" value="" />
                                                                            <span
                                                                                style="position: absolute; right: 20px;">Jahr</span>
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <span id="heating_system_age_error"
                                                                                class="text-danger"></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        ...
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                                class="form-control form-element"
                                                                                name="heating_system_year"
                                                                                id="heating_system_year" value="" />
                                                                        </div>
                                                                        <div class="col-md-12">
                                                                            <span id="heatingYearError"
                                                                                class="text-danger"></span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Welches Heizsystem ist verbaut?
                                                                            </p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <select name="heating_type" id="heating_type"
                                                                                ...
                                                                                <option value="heating_system">Heizkörper
                                                                                </option>
                                                                                <option value="both">Fußbodenheizung +
                                                                                    Heizkörper</option>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wo befindet sich die aktuelle
                                                                                Heizungsanlage?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                id="installation_location_extra"
                                                                                value="{{ old('installation_location_extra', $customer->installation_location_extra)}}"
                                                                                placeholder="SONSTIGIES..">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wie hoch ist Ihr jährlicher
                                                                                Stromverbrauch?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ old('annual_consumption')}}" />
                                                                            <span
                                                                                style="position: absolute;right: 20px;">kWh</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <p class="primary"><strong>HEIZENERGIE
                                                                            VERBRAUCH</strong></p>
                                                                </div>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p>Wie hoch ist Ihr jährlicher Verbrauch an
                                                                                Heizenergie?</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <!-- Conersion of CMB to KWH, cmb * 10  -->
                                                                            <input type="number"
                                                                                class="form-control form-element mr-1"
                                                                                name="annual_heating_energy_consumption"
                                                                                id="annual_heating_energy_consumption"
                                                                                value="{{ old('annual_heating_energy_consumption')}}" />
                                                                            <span id="heat-energy">m³</span>
                                                                            <input type="number"
                                                                                class="form-control form-element mr-1"
                                                                                name="annual_heating_energy_consumption_kwh"
                                                                                id="annual_heating_energy_consumption_kwh"
                                                                                value="{{ old('annual_heating_energy_consumption_kwh')}}" />
                                                                            <span>kWh</span>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Haben Sie ein Elektroauto? Oder
                                                                                planen Sie eins zu kaufen?</p>
                                                                        </div>
                                                                        <br>
                                                                        <div class="col-md-6 flex_me">
                                                                            <select class="form-control form-element"
                                                                                name="electric_car" id="electric_car">
                                                                                <option selected disabled></option>
                                                                        ...
                                                                        <div class="col-md-6 flex_me">
                                                                            <input type="number"
                                                                                class="form-control form-element"
                                                                                name="electric_car_plan"
                                                                                id="electric_car_plan" value="" />
                                                                            <span
                                                                                style="display:none;position: absolute; right: 20px;"
                                                                                id="electric_car_plan_l">Anzahl</span>
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group row form-element">
                                                                        <div class="col-md-12">
                                                                            <p class="bold">Wieviele Kilometer hat das Auto
                                                                                gefahren? (Alle Kilometer addieren)</p>
                                                                        </div>
                                                                        <div class="col-md-12 flex_me">
                                                                            <input type="number"
                                                                                class="form-control form-element"
                                                                                name="car_kilo" value="" />
                                                                            <span
                                                                                style="position: absolute;right: 20px;">km</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit"
                                                            class="btn btn-primary waves-effect waves-light">Speichern</button>
                                                        <button type="button"
                            ...
                            <div class="card p-1" id="customer-image" data-id="" style="display: none;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <button type="button"
                                            class="btn btn-outline-warning waves-effect waves-light upload-image"
                                            data-customer="" data-alteranative="" data-toggle="modal" data-target="#large">
                                            Hochladen
                                        </button>

                                        <div class="modal fade text-left" id="large" tabindex="-1" role="dialog"
                                            aria-labelledby="myModalLabel17" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('customer_upload') }}" method="POST"
                                                            class="dropzone" id="upload-customer-image"
                                                            enctype="multipart/form-data"
                                                            style="background: transparent; border: 1px dashed #8fc73e; border-radius: 20px;">
                                                            @csrf
                                                            ...
                                                            <div>
                                                                ...
                                                                <select id="article_group" class="form-control"
                                                                    name="product_id">
                                                                    <option value="">-- Wählen Sie eine Artikelgruppe --
                                                                    </option>
                                    ...
                                    <div class="modal fade" id="imageModal" tabindex="-1" aria-labelledby="imageModalLabel"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="range" id="image_zoom" min="1" max="5" step="0.1"
                                    ...
                                    <div class="modal fade text-left" id="customer_document" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a id="download_button" href="#" download
                                                        class="btn btn-success">Download Document</a>
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
                                                            ...
                                                            <li class="nav-item tab-control">
                                                                <a class="nav-link tab-control active" id="check-tab"
                                                                    data-toggle="tab" href="#home-just" role="tab"
                                                                    aria-controls="home-just" aria-selected="true"
                                                                    data-product="">CHECKLISTE</a>
                                                            </li>

                                                            <li class="nav-item tab-control">
                                                                <a class="nav-link tab-control" id="messages-tab-justified"
                                                                    data-toggle="tab" href="#messages-just" role="tab"
                                                                    aria-controls="messages-just"
                                                                    aria-selected="true">PROJEKTMANAGEMENT</a>
                                                            </li>
                                                        </ul>
                                                        ...
                                                        <div class="tab-content pt-1">
                                                            <div class="tab-pane active" id="home-just" role="tabpanel"
                                                                ...
                                                                <!-- checklists  -->
                                                                <div class="pv_details">
                                                                    @include('admin.new_leads.checklists.pv_detail')
                                                                </div>

                                                                <div class="wp_details">
                                                                    @include('admin.new_leads.checklists.wp_detail')
                                                                </div>
                                                            </div>
                            ...
                            <div class="modal fade" id="doneModal" tabindex="-1" role="dialog"
                                aria-labelledby="doneModalTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                                    role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form id="doneTaskForm">
                                            ...
                                            <div class="modal-body">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <div class="photo"
                                                                    ...
                                                                    <div class="avatar mr-1">
                                                                        <img src="{{ asset('images/employee/' . $current_user->image) }}"
                                                                            alt="{{ $current_user->name }}" height="32"
                                                                            width="32">
                                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="responsible_person" class="form-control select_option"
                                                        style="width:100%;">
                                                        <option></option>
                                                            ...
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio"
                                                                            class="custom-control-input internal" checked
                                                                            name="outside_type" id="internal" checked="">
                                                                        <label class="custom-control-label"
                                                                            for="internal">Intern</label>
                                                                    </div>
                                                                </fieldset>
                                                            </li>
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio"
                                                                            class="custom-control-input external"
                                                                            name="outside_type" id="external">
                                                                        <label class="custom-control-label"
                                                                            for="external">Extern</label>
                                                                    </div>
                                                                </fieldset>
                                                            </li>
                                                        </ul>
                                                ...
                                                <div class="form-group outside_company">
                                                    <label for="outside_company">Ausführende
                                                        <code>Ausgelagert</code></label>
                                                    <select name="outside_company" class="form-control select_option "
                                                        style="width:100%;">
                                                        <option></option>
                                                        @foreach($outside as $out)
                                                            <option value="{{ $out->id }}">{{ $out->company_name }} -
                                                                {{ number_format($out->price, 2) }} € </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group outside_service ">
                                                    ...
                                                    <select name="outside_service" class="form-control select_option"
                                                        style="width:100%;">
                                                        <option></option>
                                                        @foreach($employees as $contact)
                                                            <option value="{{ $contact->id }}">{{ $contact->name }}
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="file-icon" class="form-control"
                                                                    name="document_name" value=""
                                                                    placeholder="Dukument Name"
                                                                    data-np-intersection-state="visible">
                                                                <div class="form-control-position">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" id="file-icon" class="form-control"
                                                                    name="document_sum" value=""
                                                                    placeholder="Dukument Summe"
                                                                    data-np-intersection-state="visible">
                                                                <div class="form-control-position">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="position-relative has-icon-left">
                                                                <textarea name="document_note" class="form-control" value=""
                                                                    placeholder="Dukument Notiz"
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    id="save-task-btn">speichern</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <!-- Sub Task Modal -->
                            <div class="modal fade" id="doneSubTaskModal" tabindex="-1" role="dialog"
                                aria-labelledby="doneSubTaskModalTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                                    role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <form id="doneSubTaskForm">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="position-relative has-icon-left">
                                                                <div class="photo"
                                                                    ...
                                                                    <input type="hidden" name="contact_person" value="13"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <ul class="list-unstyled mb-0">
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio"
                                                                            class="custom-control-input subinternal"
                                                                            name="outside_types" id="subinternal"
                                                                            checked="">
                                                                        <label class="custom-control-label"
                                                                            for="subinternal">Intern</label>
                                                                    </div>
                                                                </fieldset>
                                                            </li>
                                                            <li class="d-inline-block mr-2">
                                                                <fieldset>
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio"
                                                                            class="custom-control-input subexternal"
                                                                            name="outside_types" id="subexternal">
                                                                        <label class="custom-control-label"
                                                                            for="subexternal">Extern</label>
                                                                    </div>
                                                                </fieldset>
                                                            </li>
                                                        </ul>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">abbrechen</button>
                                                <button type="button" class="btn btn-primary"
                                                    id="save-sub-task-btn">speichern</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
...
@section('script')
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll(".nav-link").forEach((link) => {
                link.addEventListener("click", function () {
                    ...
                    const product = this.getAttribute("data-product");  // ✅ Ensure `product` is fetched

                    if (!customer || !alternative || !product) {  // ✅ Ensure all variables exist
                        console.error("Missing required data: customer, alternative, or product.");
                    ...
                    // Handle "Objekt & Energiedaten"
                        ...
                        fetch(`/get_object_data/${customer}/${alternative}/${product}`)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Function to update the field via AJAX
                ...
                fetch("{{ route('update-field.pv') }}", {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            // Update field display with new value
                            element.parentElement.innerText = newValue;
            ...
            document.querySelectorAll('.editable').forEach(element => {
                element.addEventListener('dblclick', function () {
                    if (!this.querySelector('input')) {
                        ...
                        input.setAttribute('data-field', this.getAttribute('data-field'));
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll(".nav-link#image").forEach((link) => {
                link.addEventListener("click", function () {
                    const customer = this.getAttribute("data-customer");
                    const alternative = this.getAttribute("data-alternative");
                    const product = this.getAttribute("data-product"); // ✅ Fixed: Get product

                    if (!customer || !alternative || !product) {
                        console.error("Missing required data: customer, alternative, or product.");
                        return;
                    }
                    ...
                    fetchImagesAndDocuments(customer, alternative, product); // ✅ Fixed: Pass product
                });
            });

            // ✅ Fixed: Pass `product` as a parameter
            function fetchImagesAndDocuments(customer, alternative, product) {
                const url = `/customer_image_get/${customer}/${alternative}/${product}`;
                            ...
                            if (['jpeg', 'jpg', 'png', 'gif'].includes(fileType)) {
                                const imageHtml = `
                                    <div class="col-md-3" data-id="${item.id}">
                                        <div class="card-content">
                                            ...
                                            <div class="card-body p-0">
                                                <p class="card-title edit_image_name mt-1" data-id="${item.id}" ondblclick="makeEditable(this)">
                                                    ${item.image_name}
                                                </p >
                                ...
                                const docHtml = `
                                    <div class="col-md-12">
                                        ...
                                        : `<i class="fa fa-file-${fileType}" style="font-size: 50px;"></i>`}
                                            </div>
                                            <div class="card-body">
            ...
            // ✅ Fixed: Ensure SweetAlert delete works correctly
                        ...
                        fetch(`/customer_image_destroy/${imageId}`, {
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    this.closest(".col-md-3, .col-md-12").remove(); // ✅ Fixed: Correctly removing element
                                } else {
                                    Swal.fire("Fehler!", "Das Bild konnte nicht gelöscht werden.", "error");
                                }
                            })
                            .catch(error => {
    ...
    <script>
        $(document).on('click', '.files', function () {
            ...
            // Correctly update the data attribute of #check-tab
    ...
    <!-- checklist view PV or WP :start  -->

    <script>
        $(document).ready(function () {
            function toggleDetails() {
                let productType = $('#check-tab').attr('data-product') || ''; // Ensure it's not undefined

                console.log("Product Type:", productType); // Debugging: Check what value is being read

                if (productType.toLowerCase() === 'pv') {
                    $('.pv_details').show();
                    $('.wp_details').hide();
                } else if (productType.toLowerCase() === 'wp') {
                    $('.wp_details').show();
                    $('.pv_details').hide();
                } else {
                    $('.pv_details, .wp_details').hide();
                }
            }
            ...
            // Ensure data-product is updated before running toggleDetails
            $(document).on('click', '.files', function () {
                let newProductType = $('#check-tab').attr('data-product');
                console.log("New Product Type after click:", newProductType); // Debugging
                toggleDetails();
            });
        });
    </script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.querySelectorAll(".roof_editable").forEach(function (element) {
                element.addEventListener("dblclick", function () {
                    ...
                    function updateField() {
                        ...
                        let customerId = document.getElementById("roof_customer")?.value;
                        let alternativeId = document.getElementById("roof_alternative")?.value;
                        let roofId = document.getElementById("roof_id")?.value;

                        if (!customerId || !alternativeId || !roofId) {
                            toastr.error("Customer ID, Alternative ID, or Roof ID is missing!");
                            element.innerText = currentValue;
                            return;
                        }

                        fetch("/lead/roof/edit", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                                "X-CSRF-TOKEN": document.querySelector("meta[name='csrf-token']").getAttribute("content")
                            ...
                            body: JSON.stringify({
                                roof_customer: customerId,
                                roof_alternative: alternativeId,
                                roof_id: roofId,
                                field: field,
                                value: newValue
                            })
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    toastr.success(`Updated ${field} to ${newValue}`);
                                } else {
                            ...
                            .catch(error => {
                                ...
                                toastr.error("Error updating field: " + error.message);
                                element.innerText = currentValue;
                            });
                    }
