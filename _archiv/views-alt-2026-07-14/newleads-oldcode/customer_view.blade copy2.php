                                                    ...
                                                    <tbody>
                                                        @foreach($data as $item)    
                                                            <tr style="background:white;border-bottom: 13px solid #f8f8f8;" class="mb-2"> 
                                                                ...
                                                                <td><a href="{{url('new_lead_profile/'.$item->id )}}">
                                                                     {{ $item->name }}  {{ $item->lastname }} </a></td>
                                                                    <td>
                                                                    <i class="feather icon-pin"></i> {{ $item->alt_street ?? null }} <br>
                                                                    {{ $item->alt_postcode }} <br>
                                                                    {{ $item->alt_city }}</td>  
                                                                <td>
                                                                                ...
                                                                                @endphp
                                                                                 ...
                                                                                 @php
                                                                                    ...
                                                                                    <div class="text">{{ $services[$product->service] ?? $product->service }}</div>
                                                                                        @if($product->current_employee == auth()->user()->name && $status=='send')
                                                                                            <button type="button"  
                                                                                                    class="btn btn-primary mr-1 mb-1 waves-effect waves-light p-1"  
                                                                                                    data-toggle="modal" 
                                                                        ...
                                                                        <div class="modal fade text-left" id="addEmployee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <form method="post" action="{{ route('save.selectedEmployees') }}">
                                                                                        @csrf
                                                                ...
                                                                <div class="btn-group dropup dropdown-icon-wrapper mr-1 mb-1"> 
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <span class="dropdown-item">
                                                                        <a  data-toggle="modal" 
                                                                            data-target="#add_employee{{$item->id}}"   
                                                                            data-employee-id="{{ $employee->id }}" 
                                                                            data-product-id="{{ $product->product_id }}" 
                                                                            data-new-lead-id="{{ $item->id }}" >
                                                                        ...
                                                                        @if(DB::table('user_rolls')->where('user_rolls.user_id', '=', auth()->user()->name)->where('user_rolls.item_id', '=', 'Customer')->where('user_rolls.is_update', '=', 'on')->first())
                                                                        <span class="dropdown-item">
                                                                        <a  href="{{ url('/new_lead_edit/'.$item->id)}}" ><i class="feather icon-edit" ></i> Bearbeiten</a> 
                                                                        </span>
                                                                        @endif
                                                                        @if(DB::table('user_rolls')->where('user_rolls.user_id', '=', auth()->user()->name)->where('user_rolls.item_id', '=', 'Customer')->where('user_rolls.is_delete', '=', 'on')->first())
                                                                            ...
                                                                            @else
                                                                                 <span class="dropdown-item danger">
                                                                                <a data-toggle="modal" data-target="#delete-pro{{$item->id}}"><i class="feather icon-trash-2 danger" ></i>Wiederherstellen</a>
                                                                            </span>
                                                                            @endif
                                                                        @endif
                                                                    ...
                                                                    <div class="modal fade text-left" id="add_employee{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                                                                                ...
                                                                                                <!-- Delete Confirmation Modal -->
                                                                                                    ...
                                                                                                    <div class="modal-dialog" role="document">
                                                                                                        ...
                                                                                                        <div class="modal-body">
                                                                                                            ...
                                                                                                            <input class="form-check-input" type="checkbox" id="deleteEmployee" value="employee">
                                                                                                            <label class="form-check-label" for="deleteEmployee">Delete Employee</label>
                                                                                                            </div>
                                                                                                            <div class="form-check">
                                                                                                            <input class="form-check-input" type="checkbox" id="deleteProduct" value="product">
                                                                                                            <label class="form-check-label" for="deleteProduct">Delete Product</label>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div class="modal-footer">
                                                                ...
                                                                <td> 
                                                                     ...
                                                                     <button type="button" style="width:143px"
                                                                                class="btn btn-primary mr-1 mb-1 waves-effect waves-light"  
                                                                                data-toggle="modal" 
                                                                                data-target="#nextStep{{$item->id}}">
                                                                           <span style="font-size: 10px;" > Nächster Schritt</span>
                                                                        </button>
                                                                  

                                                                    <div class="modal fade text-left" id="accept{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="false">
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable " role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header bg-primary white">
                                                                                    ...
                                                                                    <div class="table-responsive">
                                                                                        <table class="table">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr> 
                                                                                                    <td>{{ $item->name }} {{ $item->lastname }}</td> 
                                                                                                    <td><span id="product_name">Unkown</span></td> 
                                                                                                    <td>{{ $item->street }} {{$item->postcode}}, {{$item->city}}</td>
                                                                                                </tr> 
                                                                                            </tbody>
                                                                                        </table>
                                                                    ...
                                                                    <div class="modal fade text-left" id="nextStep{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="false">
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header bg-primary white">
                                                                                    <h5 class="modal-title" id="myModalLabel160">Nächster Schritt: Planung</h5>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                        <span aria-hidden="true">×</span>
                                                                                    </button>
                                                                                </div>
  ...
  document.querySelectorAll('[data-toggle="modal"]').forEach(button => {
    button.addEventListener('click', function() {
        ...
        if (modal) {
            ...
            modal.querySelector('#product_name').textContent = productName;
            modal.querySelector('input[name="employee_id"]').value = employee;
...
<!-- deleteing the responsible and product from the list of empoyee modal:start  -->
 <script>
   document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.delete-responsible').forEach(button => {
        button.addEventListener('click', function () {
            const responsibleId = this.getAttribute('data-responsible');
            const productId = this.getAttribute('data-product');

            // Set the modal's data attributes for later use
            document.getElementById('confirmDelete').setAttribute('data-responsible', responsibleId);
            document.getElementById('confirmDelete').setAttribute('data-product', productId);
    ...
    document.getElementById('confirmDelete').addEventListener('click', function () {
        const responsibleId = this.getAttribute('data-responsible');
        const productId = this.getAttribute('data-product');
        const deleteEmployeeCheckbox = document.getElementById('deleteEmployee').checked;
        const deleteProductCheckbox = document.getElementById('deleteProduct').checked;

        let url = '';
        if (deleteEmployeeCheckbox && responsibleId) {
            url = `/delete_lead_responsible/${responsibleId}`;
        } else if (deleteProductCheckbox && productId) {
