...
@section('style')
  ...
  <style>
    ...
    /* ADD THESE TWO LINES */
    .list-live-feed { display: none !important; }
    .list-live-feed.force-show-feed { display: flex !important; }
  ...
  <style>
    ...
    .tl-dot.tl-green.is-active { background-color: #93c21c;   }
    .tl-dot.tl-orange.is-active { background-color: #fd7e14;   }
    .tl-dot.tl-red.is-active { background-color: #dc3545;   }
  ...
  .table .kb-status.is-expanded .meta {
      display: grid !important; /* Preserves your grid semantics */
  }
  ...
  <section id="basic-tabs-components">
    ...
    <div class="pro-layout">
        ...
        <aside class="pro-rail" aria-label="Aktionen">
            <button class="rail-btn" id="btnOpenDrawer" title="Übersicht & Filter" type="button">
          ...
          <form id="kanbanFilterForm" class="row align-items-end g-2">
            ...
            <div class="col-md-6">
              ...
              <select name="stage" id="stageFilter" class="form-control select2">
                ...
                @foreach(($stageNames ?? ['lead' => 'Lead', 'offer' => 'Angebot', 'deal' => 'Auftrag', 'project' => 'Montage', 'completed' => 'Abschluss']) as $key => $label)
           ...
           <div class="col-12">
              ...
              <div class="d-flex flex-wrap" id="columnTogglesContainer">
                  @foreach(($stageNames ?? ['lead' => 'Lead', 'offer' => 'Angebot', 'deal' => 'Auftrag', 'project' => 'Montage', 'completed' => 'Abschluss', 'archive' => 'Archiv']) as $key => $label)
 ...
 @section('script')
    ...
    function bindColumnTools() {
      ...
      function buildStatusBlock(lead) {
        ...
        // CHANGED: Wrapped the badges in a flex container (d-flex align-items-center gap-1)
        // removed the extra wrapping divs that caused line breaks.
        return `
          <div class="kb-status" title="Klicken zum Aus-/Einklappen">
            <div class="d-flex align-items-center gap-1">
              <span class="badge bg-${tone} badge-${tone} ${extra} mr-1">${txt}</span>
              <span class="badge bg-primary">
                <i class="feather icon-play"></i> Aktiv 
                <i class="feather icon-chevron-down meta-toggle-icon"></i>
              </span>
            </div>
            <div class="meta">
