...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('climate_locations')) {
            return;
        }
        ...
        Schema::create('climate_locations', function (Blueprint $table) {
            ...
            $table->string('location_mapping_id')->nullable(); // ID_Location_StationMapping
            $table->string('postcode', 20);                    // ID_Location
            ...
            $table->string('name')->nullable(); // Name_Location
            ...
            $table->index(['postcode'], 'cl_postcode_idx');

            $table->index(
                ['postcode', 'country_code'],
                'cl_postcode_country_idx'
            );
