...
@section('title') Nuen Rechnung @endsection
@section('style')
<!-- Include stylesheet -->
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Neu</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        @endif
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="{{ action('App\Http\Controllers\InvoiceController@store')}}"   class="custom-file-upload" enctype="multipart/form-data">
                                        @csrf    
                                        <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="first-name" class="form-control" value="{{old('invoice_no')}}" name="invoice_no"  required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="date" id="first-name" class="form-control" value="{{old('invoice_date')}}" name="invoice_date" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                            ...
                                                            <div class="col-md-8">
                                                                <fieldset class="form-group">
                                                                    <select class="select2-customize-result form-control" name="customer" id="custom" required style="width:100%">
                                                                        ...
                                                                        <option value="{{ $cus->id }}">{{ $cus->name }} {{ $cus->lastname }} - {{ $cus->city }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </fieldset>
                                                            </div>
                                                            ...
                                                            <div class="col-md-8">
                                                                <fieldset class="form-group">
                                                                    <select class="select2-customize-result form-control" name="employee" id="empl" required style="width:100%">
                                                                        ...
                                                                        <option value="{{ $empl->id }}">{{ $empl->name }} {{ $empl->lastname }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </fieldset>
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="select2-customize-result form-control" name="purchased_by" id="purchased_by"  required>
                                                                    ...
                                                                    <option value="{{ $purchase->id }}">{{ $purchase->name }} {{ $purchase->lastname }}</option>
                                                                    @endforeach
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="select2-customize-result form-control"  name="edited_by" id="edited_by"  required >
                                                                    ...
                                                                    <option value="{{ $edit->id }}">{{ $edit->name }} {{ $edit->lastname }}</option>
                                                                    @endforeach
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="file" id="first-name" class="form-control" value="{{old('pdf')}}" name="pdf" required>
                                                            </div>
                                                        </div>
                                                    </div>
