                        ...
                        @if ($key === 'tasks')
                            ...
                            @elseif ($key === 'appointments')
                                <div class="font-semibold text-green-600 flex justify-between items-center">
                                    <span>{{ $item['name'] ?? '-' }}</span>
                                    <span class="w-3 h-3 rounded-full inline-block" style="background-color: {{ $item['color'] ?? '#10b981' }}"></span>
                                    </div>
                                ...
                                <div class="flex justify-between items-center mt-2">
                                    ...
                                    @if (!empty($item['id']))
                                            <a href="{{ url($section['route'] . '/' . $item['id']) }}">Details anzeigen</a>
                                        @else
                                            <span class="text-xs text-gray-400">Keine ID</span>
                                        @endif
                                </div>
                            ...
                            @elseif ($key === 'problems')
                                    ...
                                    <div class="text-xs text-gray-500 mt-1"><i class="feather icon-settings"></i> {{ $item['article'] ?? '-' }}</div>
