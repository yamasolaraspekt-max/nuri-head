                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="card"  id="cards">
                                        <a href="{{ url('/project_details/'.$item->id) }}">
                                        <div class="card-body" style="align-self: center;">
                                          
                                            <img src="{{ asset('images/icons/folder.png') }}" alt="element 02" width="50" class="mb-1 img-fluid">
                                            <h6 style="    font-size: 12px;" class="card-text">{{ $item->project }}</h6>
