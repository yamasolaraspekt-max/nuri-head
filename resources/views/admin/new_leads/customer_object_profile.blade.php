                        ...
                        <div class="col-md-4 col-sm-3 ">
                            <div class="card mb-1" style="justify-self: flex-start;">
                                <div class="card-header p-1" >
                                    <div class="col-5"> 
                                        <p style="font-size: 12px;font-weight: bold; margin-bottom:0; position:absolute"> 
                                            <a href="{{ url('new_lead_edit/'.$customer->id.'/'.$alternative->id)}}"><i class="feather icon-edit primary"></i></a> {{ strtoupper($alternative->object_name) }} </p> 
                                ...
                                <div class="card-content" style="">  
                                                                        ...
                                                                        @foreach ($product_list->where('customer_id', $customer->id)->where('alternative_id', $alternative->id)->unique(fn($product) => $product->product_id.'-'.$product->alternative_id) as $product)
                                                                            ...
                                                                            @php
                                                                                    ...
                                                                                    $employeeImage = file_exists('images/employee/'.$emp_image) && $emp_image 
                                                                                        ...
                                                                                        : $defaultImage;
                                                                                @endphp 
                                                                            <div id="heading1" class="card-header collapse-header collapsed" data-toggle="collapse" role="button" data-target="#accordion{{$product->product_id}}" aria-expanded="false" aria-controls="accordion{{$product->product_id}}">
                                                                                <span class="lead collapse-title"> 
                                                                                    <div class="title-product"  style="display: flex;  align-items: center;">
                                                                                        <div class="product-item" style="    width: 60px;">
                                                                                            <div class="circle">{{ $product->initial }}</div>   
                                                                                        </div>
                                                                                        <div class="service-item" style="    width: 177px;">
                                                                            ...
                                                                            <div id="accordion{{$product->product_id}}" role="tabpanel" data-parent="#accordionWrapa1" aria-labelledby="heading1" class="collapse" style="">
                                                                                <div class="card-content">
                                                                                    <div class="card-body">
                                                                                            <p>
                                                                                        <ul class="nav nav-pills flex-column mt-md-0 mt-1"> 
                                                                                            <li class="nav-item">
                                                                                                <a class="nav-link d-flex files"  id="files" data-id="{{$alternative->id}}"    data-service="{{ $product->service }}"
                                                                                                    data-initial="{{ $product->initial }}"  data-alternative="{{$alternative->id}}" data-customer="{{$customer->id}}" data-product="{{$product->product_id}}" data aria-expanded="true"> 
                                                                                                  Projekt & Checkliste
                                                                                                </a>
                                                                                            </li>
                                                                                            <li class="nav-item">
                                                                                                <a class="nav-link d-flex  energy-link"  id="energe" data-id="{{$alternative->id}}"  data-alternative="{{$alternative->id}}" data-customer="{{$customer->id}}" data-product="{{$product->product_id}}" data aria-expanded="true"> 
                                                                                                    Objekt & Energiedaten
                                                                                                </a>
                                                                                            </li>
                                                                                            <li class="nav-item">
                                                                                                <a class="nav-link d-flex " id="image" data-id="{{$alternative->id}}"  data-alternative="{{$alternative->id}}" data-customer="{{$customer->id}}" data-product="{{$product->product_id}}" aria-expanded="false"> 
                                                                                                Bilder & Unterlagen
                                                                                                </a>
                                                                                            </li>
                                                                                            <li class="nav-item">
                                    ...
                                    <!-- Edit Buttons  -->
                                    <div class="row">
                                            <button type="button" data-toggle="modal" data-target="#delete-alter{{$alternative->id}}" class="btn btn-outline-primary square ml-2 mb-1 waves-effect waves-light">Löschen</button>
                                    </div>
                                    <!-- Edit Buttons  -->
                                    <div class="modal fade" id="delete-alter{{$alternative->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true" data-backdrop="false">
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a type="button" href="{{url('/delete_lead_alternative').'/'.$alternative->id}}" class="btn btn-danger">Ja</a>
                                                </div>
                                                            ...
                                                            <div class="row" style="    background: white;">
                                                                <div class="col-md-6">
                                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="col-12"><p class="primary"><strong>DACH-INFORMATION</strong></h2></div> 
                                                                        <div class="col-12">
                                                                            <div class="form-group row form-element">
                                                                                <div class="col-md-12">
                                                                                    <p class="bold">Welche Art vom Dach haben Sie?</p>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="col-12"><p class="primary"><strong>HEIZUNGS-INFORMATION</strong></h2></div> 
                                                                        <div class="col-12">
                                                                            <div class="form-group row form-element">
                                                                                <div class="col-md-12">
                                                                                    <p class="bold">Welche Art von Heizungsanlage haben Sie?</p>
                                                                        ...
                                                                        <div class="col-12"><p class="primary"><strong>STROMVERBRAUCH</strong></p></div> 
                                                                        ...
                                                                        <div class="col-12"><p class="primary"><strong>HEIZENERGIE VERBRAUCH</strong></p></div> 
                                                                        
                                                                        <div class="col-12">
                                                                            <div class="form-group row form-element">
                                                                                <div class="col-md-12">
                                                                                    <p>Wie hoch ist Ihr jährlicher Verbrauch an Heizenergie?</p>
                                                                                </div>
                                                                                <div class="col-md-12 flex_me">
                                                                        ...
                                                                        <div class="col-12"><p class="primary"><strong>E-MOBILITÄT</strong></p></div> 

                                                                        <div class="col-12">
                                                                            <div class="form-group row form-element">
                                                                                <div class="col-md-12">
                                                                                    <p class="bold" >Haben Sie ein Elektroauto? Oder planen Sie eins zu kaufen?</p>
                                                                                </div>
                                                                                <br>
                                                                                <div class="col-md-6 flex_me">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group row form-element">
                                                                                <div class="col-md-12">
                                                                                    <p class="bold">Wieviele Kilometer hat das Auto gefahren? (Alle Kilometer addieren)</p>
                                                                                </div>
                                                                                <div class="col-md-12 flex_me">
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
                                                            ...
                                                            <li class="nav-item tab-control">
                                                                <a class="nav-link tab-control active" id="check-tab" data-toggle="tab" href="#home-just" role="tab"
                                                                    aria-controls="home-just" aria-selected="true" data-product="">CHECKLISTE</a>
                                                            </li>
