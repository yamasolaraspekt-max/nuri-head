                    ...
                    <section id="basic-horizontal-layouts">
                        <div class="row match-height">
                             ...
                             <div class="col-xl-4 col-md-12 col-sm-12  card-fixed">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h2 class="content-header-title float-left mb-2 primary ">INTERESSE</h2>
                                    </div>
                                    <div class="col-12">
                                            <div class="card">
                                                @php
                            ...
                            <div class="col-xl-8 col-md-12 col-sm-12 card-scrollable " id="customer_data">
                                <div class="row">
                                    <div class="col-4">
                                                    ...
                                                    <div class="col-md-6 mt-1 ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mt-1">
                                                                ...
                                                                <select class="form-control text" name="heating_system_type">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mt-1">
                                                                ...
                                                                <div class="position-relative">
                                                                    ...
                                                                    <input type="hidden" name="annual_heating_energy_consumption_kwh" id="annual_heating_energy_consumption_kwh" value="{{ old('annual_heating_energy_consumption_kwh') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <span>Bemerkung</span>
