                ...
                <form class="form form-horizontal" method="post" id="customer_form"
                    ...
                    <section id="basic-horizontal-layouts">
                        <div class="row match-height"> 
                            <div class="col-xl-10 col-md-12 col-sm-12 card-scrollable " id="customer_data">
                                <div class="row">
                                    <div class="col-4">
                                        <h2 class="content-header-title float-left primary ">DATEN</h2>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="accordion" id="accordionExample" data-toggle-hover="true">
                                            <div class="card-header energy-header" id="heading4" data-toggle="collapse" role="button" data-target="#collapse4" aria-expanded="false" aria-controls="collapse4" style="background: #ffffff;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mt-1">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mt-1">
                                                                <span>Objektart<span>
                                                                <select name="objective" class="form-control text">
                                                            ...
                                                            <div class="col-md-6 mt-1">
                                                                ...
                                                                <div class="position-relative">
                                                                    ...
                                                                    <span style="position: absolute; right: 20px; top: 8px;">m²</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 mt-1">
                                                            ...
                                                            <div class="col-md-12">
                                                                <span>Bemerkung</span>
                                                                <textarea name="object_remark" class="form-control" style="height: 50px;">{{ old('object_remark') }}</textarea>
                                                            </div>
                                                        </div>

                                                        <!-- DACH-INFORMATION -->
                                                        <div class="col-12 mt-4 mb-2 pl-0">
                                                            <h2 class="primary"><strong>DACH-INFORMATION</strong></h2>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 mt-1">
                                                                <span>Dachform<span>
                                                                <select class="form-control text" name="roof_type" id="roof">
                                                                    <option selected></option>
                                                            ...
                                                            <div class="col-md-6 mt-1">
                                                                ...
                                                                <select name="roof_direction" class="form-control text">
                                                                    <option></option>
                                                            ...
                                                            <div class="col-md-12">
                                                                <span>Bemerkung</span>
                                                                <textarea name="roof_remark" class="form-control" style="height: 50px;">{{ old('roof_remark') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mt-1 ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mt-1">
                                                                ...
                                                                <select class="form-control text" name="heating_system_type" id="heating_system_type">
                                                            ...
                                                            <div class="col-md-6 mt-1">
                                                                <span>Alter<span>
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control text" name="heating_system_age" value="{{ old('heating_system_age') }}" />
                                                                    <input type="hidden" name="heating_system_year" value="{{ old('heating_system_year') }}">
                                                            ...
                                                            <div class="col-md-6 mt-1">
                                                                ...
                                                                <select name="heating_type" class="form-control text">
                                                                    <option value="">Bitte wählen</option>
                                                            ...
                                                            <div class="col-md-6 mt-1">
                                                                <span>Aufstellungsort<span>
                                                                <select name="installation_location" class="form-control text">
                                                                    <option value="">Bitte wählen</option>
                                                                ...
                                                                <input type="text" class="form-control mt-1 text" name="installation_location_extra" value="{{ old('installation_location_extra') }}" placeholder="sonstiges">
                                                            </div>
                                                            <div class="col-md-12">
                                                                <span>Bemerkung</span>
                                                                <textarea name="heating_remark" class="form-control" style="height: 50px;">{{ old('heating_remark') }}</textarea>
                                                            </div>
                                                        </div>

                                                        <!-- ENERGIEVERBRAUCH -->
                                                        <div class="col-12 mt-4 mb-2 pl-0">
                                                            <h2 class="primary"><strong>ENERGIEVERBRAUCH</strong></h2>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 mt-1">
                                                                <span>Stromverbrauch<span>
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control text" name="annual_consumption" value="{{ old('annual_consumption') }}">
                                                                    <span style="position: absolute;right: 20px;top: 8px;">kWh</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 mt-1">
                                                                    <h3>Heizenergie<span>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-6">
                                                                            <div class="position-relative">
                                                                                <input type="text" class="form-control text mr-1" name="annual_heating_energy_consumption" id="annual_heating_energy_consumption" value="{{ old('annual_heating_energy_consumption') }}">
                                                                                <span id="heat-energy" style="position: absolute;right: 20px;top: 8px;">m³</span>
                                                                            </div>
                                                                        </div>

                                                                        <div class="col-6">
                                                                            <div class="position-relative">
                                                                                <input type="text" name="annual_heating_energy_consumption_kwh" id="annual_heating_energy_consumption_kwh" class="form-control " value="{{ old('annual_heating_energy_consumption_kwh') }}">
                                                                                <span id="heat-energy" style="position: absolute;right: 20px;top: 8px;">kWh</span>
                                                                            </div>
                                                                        </div> 
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <span>Bemerkung</span>
                                                                <textarea name="energy_remark" class="form-control" style="height: 50px;">{{ old('energy_remark') }}</textarea>
                                                            </div>
                                                        </div>
    ...
    $(document).ready(function () {
        ...
        $('#add_new').click(function () {
            ...
            $('#product_table tbody').append(`
                <tr>
                    <td class="input-class d-flex align-items-center">
