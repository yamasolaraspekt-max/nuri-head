                        ...
                        <div class="default-collapse collapse-bordered"> 
                            <div class="cards collapse-header">
                                <div id="heading11" class="card-header" data-toggle="collapse" role="button" data-target="#accordion10" aria-expanded="true" aria-controls="accordion10">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title ">OBJEKTDATEN</h5>
                                    </span>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <p class="bold">Baujahr </p>
                                                        </div>
                                                        <div class="col-md-8 textbox-container"> 
                                                             {{ $wp_checklist->construction_year ?? 'N/V' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group row ">
                                                        <div class="col-md-4">
                                                            <p class="bold">beheizte Wohnfläche</p>
                                                        </div>
                                                        <div class="col-md-8 flex_me">
                                                            {{$wp_checklist->living_space ?? 'N/V'}}
                                                            <span> m²</span> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group row ">
                                                        <div class="col-md-4">
                                                            <p class="bold">Nutzfläche</p>
                                                        </div>
                                                        <div class="col-md-8 flex_me">
                                                             {{$wp_checklist->unusable_space ?? 'N/V'}} 
                                                            <span> m²</span> </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group row ">
                                                        <div class="col-md-4">
                                                            <p class="bold">Anzahl Personen</p>
                                                        </div>
                                                        <div class="col-md-8">
                                                            {{$wp_checklist->number_people ?? 'N/V'}}  
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <p class="bold">Anzahl WE</p>
                                                        </div>
                                                        <div class="col-md-8 textbox-container">
                                                            {{$wp_checklist->wp_number_we ?? 'N/V'}}   
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group row">
                                                        <div class="col-md-4">
                                                            <p class="bold">Anzahl Geschoß</p>
                                                        </div>
                                                        <div class="col-md-8"> 
                                                            {{$wp_checklist->wp_number_stories ?? 'N/V'}}   
                                                        </div>
                                                    </div>
                                                </div>
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-2">
                                                                <p class="bold ">Fensterverglasung</p>
                                                            </div>
                                                            <div class="col-md-10">
                                                                @if($wp_checklist)
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-2">
                                                                <p class="bold ">Fensterrahmen</p>
                                                            </div>
                                                            <div class="col-md-10">
                                                            {{$wp_checklist->window_margin ?? 'N/V'}}    
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group row ">
                                                            <div class="col-md-4">
                                                                <p class="bold ">Aussendämmung Stärke</p>
                                                            </div>
                                                            <div class="col-md-8 flex_me">
                                                            {{$wp_checklist->insulation_thickness ?? 'N/V'}}     
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group row ">
                                                            <div class="col-md-4">
                                                                <p class="bold ">Mauerart</p>
                                                            </div>
                                                            <div class="col-md-8 flex_me">
                                                             {{$wp_checklist->wall_type ?? 'N/V'}}      
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group row ">
                                                            <div class="col-md-4">
                                                                <p class="bold ">Mauer-stärke</p>
                                                            </div>
                                                            <div class="col-md-8 flex_me">
                                                             {{$wp_checklist->wall_thickness ?? 'N/V'}}      
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-2">
                                                                <h6 class="bold">Aufdachdämmung</h6>
                                                            </div>
                                                            <div class="col-md-10">
                                                                ...
                                                                <ul class="list-unstyled mb-0"> 
                                                                     <li class="d-inline-block mr-1"
                                                                        ...
                                                                        <div class="form-group row"> 
                                                                            <div class="col-md-8">
                                                                             {{$wp_checklist->wp_insulation ?? 'N/V'}}       
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li class="d-inline-block mr-1"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                 {{$wp_checklist->wp_insulation_strength ?? 'N/V'}}     
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            <div class="col-md-2">
                                                                <h6 class="bold">Zwischen sparrendämmung</h6>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <ul class="list-unstyled mb-0">
                                                                     <li class="d-inline-block mr-1"
                                                                    ...
                                                                    <li class="d-inline-block mr-1"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8"> 
                                                                                 {{$wp_checklist->wp_rafter_strength ?? 'N/V'}}     
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group row">
                                                                <div class="col-md-4">
                                                                    <p class="bold">Anzahl Bäder</p>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    {{$wp_checklist->wp_bathrooms ?? 'N/V'}}     
                                                                    ...
                                                                    <ul class="list-unstyled mb-0">
                                                                         <li class="d-inline-block mr-1"
                                                                            ...
                                                                            <li class="d-inline-blocks mr-1 "
                                                                                ...
                                                                                <div class="form-group row ">
                                                                                    <div class="col-md-4">
                                                                                        <p class="bold">Anzahl</p>
                                                                                    </div>
                                                                                    <div class="col-md-8"> 
                                                                                        {{$wp_checklist->wp_bathtub_count ?? 'N/V'}}  
                                                                                    </div>
                                                                                </div>
                                                                            </li>
                                                                        ...
                                                                        <li class="d-inline-blocks mr-1 "
                                                                            ...
                                                                            <div class="form-group row ">
                                                                                <div class="col-md-4">
                                                                                    <p class="bold">Abmessung</p>
                                                                                </div>
                                                                                <div class="col-md-8">
                                                                                        {{$wp_checklist->wp_bathtub_measure ?? 'N/V'}}   
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                ...
                                                                <div class="col-md-10">
                                                                    <ul class="list-unstyled mb-0">
                                                                        <li class="d-inline-block mr-1"
                                                                            ...
                                                                            <div class="form-group row"> 
                                                                                <div class="col-md-8">                                                               
                                                                                {{$wp_checklist->wp_swimming_pool ?? 'N/V'}} 
                                                                                </div>
                                                                            </div>
                                                                        </li>  
                                                                        ...
                                                                        <li class="d-inline-blocks mr-1 "
                                                                            ...
                                                                            <div class="form-group row ">
                                                                                ...
                                                                                <div class="col-md-8"> 
                                                                                    {{$wp_checklist->wp_swimming_pool_count ?? 'N/V'}}  
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                <div class="col-md-2">
                                                                    <p class="bold ">Solarthermie vorhanden</p>
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <ul class="list-unstyled mb-0">
                                                                         <li class="d-inline-block mr-1"
                                                                        ...
                                                                        <li class="d-inline-blocks mr-1"
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <div class="col-md-4">
                                                                                    <p class="bold">Anzahl der
                                                                                        Kollektoren</p>
                                                                                </div>
                                                                                <div class="col-md-8 flex_me"> 
                                                                                        {{$wp_checklist->number_collector ?? 'N/V'}}  
                                                                                    &nbsp;<span>Stk</span>
                                                                                </div>
                                                                            </div>
                                                                        </li>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                <div class="col-md-2">
                                                                    <p class="bold ">Kamin vorhanden</p>
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <ul class="list-unstyled mb-0"> 
                                                                        ...
                                                                        <li class="d-inline-blocks mr-1"
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <div class="col-md-4">
                                                                                    <p class="bold">Verbrauch</p>
                                                                                </div>
                                                                                <div class="col-md-8 flex_me"> 
                                                                                        {{$wp_checklist->chimney_usage ?? 'N/V'}} 
                                                                                    &nbsp;<span> Holz/ m3 pro
                                                                                        Jahr</span>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group row">
                                                                <div class="col-md-2">
                                                                    <p class="bold ">Heizlastberechnung vorhanden</p>
                                                                </div>
                                                                <div class="col-md-10">
                                                                    <ul class="list-unstyled mb-0">
                                                                         <li class="d-inline-block mr-1"
                            ...
                            <div class="cards collapse-header">
                                <div id="heading2" class="card-header collapsed" data-toggle="collapse" role="button" data-target="#accordion2" aria-expanded="false" aria-controls="accordion2">
                                    <span class="lead collapse-title">
                                            <h5 class="bold section_title">Energiekosten, Verbrauch, Daten</h5>
                                    </span>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                          <tr> 
                                                                <td> {{ $wp_checklist?->energy_first_year_consumption ?? 'N/V' }} {{ $wp_checklist?->energy_consumption_type ?? 'N/V' }} </td>
                                                                <td> {{ $wp_checklist?->energy_second_year_consumption ?? 'N/V' }} {{ $wp_checklist?->energy_consumption_type ?? 'N/V' }} </td>
                                                                <td> {{ $wp_checklist?->energy_third_year_consumption ?? 'N/V' }} {{ $wp_checklist?->energy_consumption_type ?? 'N/V' }} </td> 
                                                                <td> {{ $wp_checklist?->energy_total_year_consumption ?? 'N/V' }} {{ $wp_checklist?->energy_consumption_type ?? 'N/V' }} </td>     
                                                                <td> {{ $wp_checklist?->energy_avg_year_consumption ?? 'N/V' }} {{ $wp_checklist?->energy_consumption_type ?? 'N/V' }} </td>      
                                                            </tr> 

                                                            <tr> 
                                                                <td> {{ isset($wp_checklist) ? number_format($wp_checklist->energy_first_year_cost ?? 0, 2, ',', '.') . ' €' : 'N/V' }} </td>
                                                                <td> {{ isset($wp_checklist) ? number_format($wp_checklist->energy_second_year_cost ?? 0, 2, ',', '.') . ' €' : 'N/V' }} </td>
                                                                <td> {{ isset($wp_checklist) ? number_format($wp_checklist->energy_third_year_cost ?? 0, 2, ',', '.') . ' €' : 'N/V' }} </td>
                                                                <td> {{ isset($wp_checklist) ? number_format($wp_checklist->energy_total_year_cost ?? 0, 2, ',', '.') . ' €' : 'N/V' }} </td>    
                                                                <td> {{ isset($wp_checklist) ? number_format($wp_checklist->energy_avg_year_cost ?? 0, 2, ',', '.') . ' €' : 'N/V' }} </td>    
                                                            </tr>  
                                                        </tbody>
                                                    </table>
                                                </div>
                            ...
                            <div class="cards collapse-header">
                                <div id="heading4" class="card-header collapsed" data-toggle="collapse" role="button" data-target="#accordion4" aria-expanded="false" aria-controls="accordion4">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title ">AKTUELLE HEIZUNG</h5>
                                    </span>
                                </div>
                                <div id="accordion4" role="tabpanel" data-parent="#accordionWrapa10" aria-labelledby="heading4" class="collapse" aria-expanded="false">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 " >  
                                                    <p class="bold ">Heizungart</p>  
                                                      {{$wp_checklist->heatpump ?? 'N/V'}}  
                                                </div>

                                                <div class="col-md-3 "  >  
                                                    <p class="bold ">Aufstellort</p>  
                                                      {{$wp_checklist->exhibition_location ?? 'N/V'}}   
                                                </div>

                                                <div class="col-md-5 "  >  
                                                    <p class="bold ">Notiz</p>  
                                                      {{$wp_checklist->exhibation_location_note ?? 'N/V'}}    
                                                ...
                                                <div class="col-4 mt-1">
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Alter der Heizung <label id="heating_age_label"></label></p>
                                                        </div>
                                                        <div class="col-md-12 flex_me"> 
                                                                {{$wp_checklist->heating_manufacture_year ?? 'N/V'}}   
                                                ...
                                                <div class="col-3 mt-1">
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Heiztechnik</p>
                                                        </div>
                                                        <div class="col-md-12 flex_me"> 
                                                                {{$wp_checklist->heating_type ?? 'N/V'}}    
                                                ...
                                                <div class="col-4 mt-1">
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Leistung der Anlage</p>
                                                        </div>
                                                        <div class="col-md-12 flex_me"> 
                                                                {{$wp_checklist->system_performance ?? 'N/V'}}    
                                                                 &nbsp;<span>kWh</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    <div class="col-4 mt-1">
                                                        <div class="form-group row">
                                                            <div class="col-md-12 ">
                                                                <p class="bold">Hersteller</p>
                                                            </div>
                                                            <div class="col-md-12 flex_me">  
                                                                    {{$wp_checklist->heating_company ?? 'N/V'}}    
                                                    ...
                                                    <div class="col-4 mt-1">
                                                        <div class="form-group row">
                                                            <div class="col-md-12 ">
                                                                <p class="bold">Typbezeichnung</p>
                                                            </div>
                                                            <div class="col-md-12 flex_me"> 
                                                                    {{$wp_checklist->type_designation ?? 'N/V'}}    
                                                ...
                                                <div class="col-4 mt-1">
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Warmwasseraufbereitung</p>
                                                        </div>
                                                        <div class="col-md-12 flex_me">
                                                            {{$wp_checklist->hot_water_preparation ?? 'N/V'}}    
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Warmwasserverbrauch pro Person</p>
                                                        </div>
                                                        <div class="col-md-12 flex_me">
                                                            {{$wp_checklist->number_hotWaterConsumptionPerPerson ?? 'N/V'}}     
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4 mt-1">
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Heizsystem</p>
                                                        </div>
                                                        <div class="col-md-12 flex_me">
                                                            {{$wp_checklist->general_heating_system ?? 'N/V'}}     
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4 mt-1">
                                                    <div class="form-group row">
                                                        <div class="col-md-12 ">
                                                            <p class="bold">Rohrsystem</p>
                                                        </div>
                                                        <div class="col-md-12 flex_me">
                                                            {{$wp_checklist->pipe_system ?? 'N/V'}}    
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="cards collapse-header">
                                <div id="heading5" class="card-header collapsed" data-toggle="collapse" role="button" data-target="#accordion5" aria-expanded="false" aria-controls="accordion5">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title ">Hydraulichen Eignungsprüfung Fußbodenheizung & elektrischen Anschluß: </h5>
                                    </span>
                                </div>
                                <div id="accordion5" role="tabpanel" data-parent="#accordionWrapa10" aria-labelledby="heading5" class="collapse" aria-expanded="false">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-4 " >  
                                                    <p class="bold ">Heizkreisverteiler</p>  
                                                    {{$wp_checklist->heating_circuit_distributor ?? 'N/V'}}     
                                                </div>

                                                <div class="col-md-4 "  >  
                                                    <p class="bold ">Stellantriebe</p>  
                                                    {{$wp_checklist->actuators ?? 'N/V'}}      
                                                </div>

                                                <div class="col-md-4"  >  
                                                    <p class="bold ">Kühlung Funktion</p>  
                                                    {{$wp_checklist->suitable_cooling_system ?? 'N/V'}}     
                                                </div>
                            ...
                            <div class="cards collapse-header">
                                <div id="heading7" class="card-header collapsed" data-toggle="collapse" role="button" data-target="#accordion7" aria-expanded="false" aria-controls="accordion7">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title ">Hydraulichen Eignungsprüfung Heizkörper</h5>
                                    </span>
                                </div>
                                <div id="accordion7" role="tabpanel" data-parent="#accordionWrapa10" aria-labelledby="heading7" class="collapse" aria-expanded="false">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3 " >  
                                                    <p class="bold ">Heizkörper</p>  
                                                    {{$wp_checklist->radiator ?? 'N/V'}}  
                                                </div>

                                                <div class="col-md-3 "  >  
                                                    <p class="bold ">Thermostate</p>  
                                                    {{$wp_checklist->thermostats ?? 'N/V'}}   
                                                </div>

                                                    <div class="col-md-3 "  >  
                                                    <p class="bold ">Thermostatventile</p>  
                                                    {{$wp_checklist->thermostatic_valves ?? 'N/V'}}   
                                                </div>

                                                <div class="col-md-3"  >  
                                                    <p class="bold ">Kühlung Funktion</p>  
                                                    {{$wp_checklist->radiator_cooling_system ?? 'N/V'}}    
                                                </div>

                                                <div class="col-md-12 mt-2 "  >  
                                                    <p class="bold ">Notiz</p>
                                                    {{$wp_checklist->radiator_note ?? 'N/V'}}     
                                                </div> 
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="cards collapse-header">
                                <div id="heading8" class="card-header collapsed" data-toggle="collapse" role="button" data-target="#accordion8" aria-expanded="false" aria-controls="accordion8">
                                    <span class="lead collapse-title">
                                            <h5 class="bold section_title">Welche Leitungen sind verlegt?</h5>
                                    </span>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                           @if (!empty($heating) && is_iterable($heating))
                                                                @foreach ($heating as $heat)
                                                                    <tr>
                                                                        <td>{{ $heat->system ?? 'N/V' }}</td>
                                                                        <td>{{ $heat->type ?? 'N/V' }}</td>
                                                                        <td>{{ $heat->dimension ?? 'N/V' }}</td>
                                                                        <td>{{ $heat->company ?? 'N/V' }}</td>
                                                                        <td>{{ $heat->designation ?? 'N/V' }}</td>
                                                                        <td>{{ $heat->note ?? 'N/V' }}</td>
                                                                    </tr>
                                                                @endforeach
                                                            @else
                                                                <tr>
                                                                    <td colspan="6" class="text-center">Keine Heizdaten vorhanden</td>
                                                                </tr>
                                                            @endif
                            ...
                            <div class="cards collapse-header">
                                <div id="heading9" class="card-header" data-toggle="collapse" role="button" data-target="#accordion9" aria-expanded="false" aria-controls="accordion9">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title">Einbringmaße Zuwegung Heizraum</h5>
                                    </span>
                                </div>
                                                            ...
                                                            <tbody id="room_dimension_tbody">
                                                                <tr id="room_dimension_row_0"> 
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="hidden" name="room[0][room_number]" class="form-control" value="1" readonly>
                            ...
                            <div class="cards collapse-header">
                                <div id="heading13" class="card-header" data-toggle="collapse" role="button" data-target="#accordion13" aria-expanded="false" aria-controls="accordion13">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title">Zustand Zählerschrank</h5>
                                    </span>
                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped">
                                                        ...
                                                        <tbody> 
                                                                    ...
                                                                    <tr>
                                                                    <td>
                                                                        @if(isset($meter_cabinet) && $meter_cabinet->meter_cabinet == "ok") 
                                                                            OK 
                                                                        @elseif(isset($meter_cabinet) && $meter_cabinet->meter_cabinet == "upgrade") 
                                                                            ertüchtigen 
                                                                        @else 
                                                                            neu 
                                                                        @endif 
                                                                    ...
                                                                    <td> {{ $meter_cabinet->cabinet_size ?? 'N/V' }} </td>

                                                                    <td>  
                                                                        @if (!empty($electro) && is_iterable($electro))
                                                                            @foreach ($electro as $elec)
                                                                                @if(isset($meter_cabinet) && $elec->id == $meter_cabinet->meter_cabinet_company)
                                                                                    {{ $elec->name }}
                                                                                @endif
                                                                            @endforeach  
                                                                        @else
                                                                            Keine Daten <!-- This message appears if $electro is empty or null -->
                                                                        @endif
                                                                    </td>

                                                                       <td>
                                                                            <strong>Zähleradapterplatte</strong>: {{ $meter_cabinet->wp_meter_adapter_plate ?? 'N/A' }} <br>
                                                                            <strong>AC Überspannungsschutz</strong>: {{ $meter_cabinet->wp_ac_surge_protection ?? 'N/A' }} <br>
                                                                            <strong>SLS Schalter</strong>: {{ $meter_cabinet->wp_ac_switch ?? 'N/A' }} <br>
                                                                            <strong>APZ Feld</strong>: {{ $meter_cabinet->wp_apz_field ?? 'N/A' }} <br>
                                                                            <strong>Trenn-Relais</strong>: {{ $meter_cabinet->wp_disconnect_relay ?? 'N/A' }} <br>
                                                                            <strong>Potentialausgleichsschiene</strong>: {{ $meter_cabinet->wp_equipotential_bonding ?? 'N/A' }} <br>
                                                                        </td>
                            ...
                            <div class="cards collapse-header">
                                <div id="heading40" class="card-header" data-toggle="collapse" role="button" data-target="#accordion40" aria-expanded="false" aria-controls="accordion40">
                                    <span class="lead collapse-title">
                                        <h5 class="bold section_title">Lüftung</h5>
                                    </span>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <th scope="row"> {{ $wp_checklist->ventilation ?? 'N/A' }} </th>
                                                                <td> {{ $wp_checklist->ventilation_system ?? 'N/A' }} </td>
                                                                <td> {{ $wp_checklist->ventilation_company ?? 'N/A' }} </td>
                                                                <td> {{ $wp_checklist->ventilation_type ?? 'N/A' }} </td>   
                                                            </tr> 
                                                        </tbody>
                                                    </table>
                                                </div>
        ...
        $('#room_dimension_table tbody').append(`
            <tr id="room_dimension_row_${roomIndex}"> 
                ...
                <td>
                    ...
                    <input type="hidden" name="room[${roomIndex}][room_number]" class="form-control" value="${roomIndex}" readonly>
                </td>
                <td>
                    ...
                    $.each(response.data, function(index, room) {
                        $('#room_dimension_data tbody').append(`
                            <tr>
                                ...
                                <td>${room.width}</td>
                                <td>${room.height}</td>
                                <td>${room.ceiling_height ? room.ceiling_height : 'N/V'}</td>
                                <td>${room.stair_form ? room.stair_form : 'N/V'}</td>
                                <td>${room.stair_width ? room.stair_width : 'N/V'}</td>
