        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select class="form-control" name="heating_system_type">
                    <option value="" @selected(optional($alternative)->heating_system_type == '')>Bitte wählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <input type="number" step="any"  class="form-control" name="chimney" value="{{ old('chimney', optional($alternative)->chimney) }}">
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select name="heating_type" class="form-control">
                    <option value="" @selected(optional($alternative)->heating_type == '')>Bitte wählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select name="solar_thermal" class="form-control">
                    <option value="" @selected(optional($alternative)->solar_thermal == '')></option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select name="installation_location" class="form-control ">
                    <option value="" @selected(optional($alternative)->installation_location == '')>Bitte wählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select name="hot_water_generation" class="form-control">
                    <option value="" @selected(optional($alternative)->hot_water_generation == '')>Bitte wählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <input type="text" class="form-control" name="bathtub_count" value="{{ old('bathtub_count', optional($alternative)->bathtub_count) }}">
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select name="income_level" class="form-control">
                    <option value="" @selected(optional($alternative)->income_level == '')>Bitte wählen</option> 
            ...
            <div class="col-12 mt-3">
                ...
                <textarea name="heating_remark" class="form-control" rows="3">{{ old('heating_remark', optional($alternative)->heating_remark) }}</textarea>
            </div>
        </div>
