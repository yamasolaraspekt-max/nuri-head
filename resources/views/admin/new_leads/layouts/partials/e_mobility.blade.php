        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select class="form-control" name="electric_car" id="electric_car_select">
                    <option  @selected(optional($alternative)->electric_car == '')>Bitte auswählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select class="form-control" name="network_cable">
                    <option value="" @selected(optional($alternative)->network_cable == '')>Bitte auswählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select class="form-control" name="groundwork">
                    <option value="" @selected(optional($alternative)->groundwork == '')>Bitte auswählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select class="form-control" name="company_vehicle">
                    <option value="" @selected(optional($alternative)->company_vehicle == '')>Bitte auswählen</option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 d-flex align-items-center mb-2">
                ...
                <select class="form-control" name="bidirectional_car">
                    <option value="" @selected(optional($alternative)->bidirectional_car == '')>Bitte auswählen</option>
