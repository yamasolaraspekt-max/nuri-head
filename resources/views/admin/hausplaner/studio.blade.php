...
<head>
    ...
    <style>
        ...
        .hp-scratch { margin-left: auto; font-size: 12px; font-weight: 700; color: #b45309; background: var(--sa-warning-bg, #fff7ed); border: 1px solid #fed7aa; border-radius: 999px; padding: 4px 12px; }
