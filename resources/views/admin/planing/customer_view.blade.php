                                                            ...
                                                            <tr style="background:white;border-bottom: 13px solid #f8f8f8;" class="mb-2"> 
                                                             ...
                                                             @php
                                                                    ...
                                                                    if ($employee) {
                                                                        ...
                                                                        $c_image = 'default_image.png';  // Provide a default image if null
                                                                        $c_name = 'Unknown';
                                                                        $c_lastname = '';
                                                                    }
                                                                @endphp
                                                                        ...
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <a type="button" href="{{url('/plan/delete').'/'.$item->id}}" class="btn btn-danger">Ja</a>
                                                                                </div>
                                                                                @else
                                                                                    <div class="modal-body"> 
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <a type="button" href="{{url('/deal/restore').'/'.$item->id}}" class="btn btn-danger">Ja</a>
                                                                                </div>
                                                                                @endif
                                                                            </div>
                                                                        </div>
