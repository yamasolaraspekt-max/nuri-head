              ...
              <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800">
                <div class="pt-4 px-4 pb-4 space-y-2">
                  ...
                  <div class="grid grid-cols-3 gap-2">
                    ...
                    <button class="h-12 rounded-xl bg-gray-100 dark:bg-gray-900 text-sm font-medium flex items-center justify-center gap-2 border border-gray-200 dark:border-gray-800" @click="openUpload({scope:'appointment',kind:'audio',apptId: appointments[0]?.id})"><i data-lucide="mic" class="w-4 h-4"></i> Bricht</button>
                  </div>
