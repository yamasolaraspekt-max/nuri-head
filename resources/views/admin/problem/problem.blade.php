...
@section('style')
    ...
    <style>
        ...
        .tc-card-icon.green { background: var(--tc-primary-light); color: var(--tc-primary); }
        .tc-card-icon.orange { background: var(--tc-warning-light); color: #d97706; }
        .tc-card-icon.red { background: var(--tc-danger-light); color: var(--tc-danger); }
        ...
        .tc-card-body { padding: 22px; }
        .tc-card-toggle { border: none; background: transparent; padding: 0; }
        .tc-card.is-collapsed .tc-card-head { border-bottom: none; }
        ...
        .tc-col-9 { grid-column: span 9; }
        .tc-col-8 { grid-column: span 8; }
        .tc-col-6 { grid-column: span 6; }
        .tc-col-4 { grid-column: span 4; }
        .tc-col-3 { grid-column: span 6; }
        ...
        @media(max-width: 920px) {
            ...
            .tc-col-6,
            .tc-col-4,
            .tc-col-3 { grid-column: span 12; }
        }

        .tc-field { min-width: 0; width: 100%; }
        ...
        .tc-field textarea.form-control { min-height: 120px !important; }
        ...
        .select2-dropdown { z-index: 100500 !important; }
        ...
        .tc-check-panel { border-color: var(--tc-border); background: #f9fafb; box-shadow: none; }
        ...
        .tc-switch-line .vs-checkbox-con { margin: 0; }
        ...
        .ticket-stage-pill { border-left-width: 4px; }
        .ticket-status-badge { background: #eff6ff; color: #1d4ed8; border-color: #bfdbfe; }
        .ticket-age-badge { background: #f9fafb; color: #4b5563; border-color: #e5e7eb; }
        .ticket-status-badge.status-completed { background: #ecfdf5; color: #065f46; border-color: #a7f3d0; }
        .ticket-status-badge.status-junk { background: #fef2f2; color: #991b1b; border-color: #fecaca; }
        ...
        .ticket-availability-alert.is-ok { background: #ecfdf5; border: 1px solid #a7f3d0; color: #065f46; }
        .ticket-availability-alert.is-warning { background: #fff7ed; border: 1px solid #fed7aa; color: #9a3412; }
        .ticket-availability-alert.is-danger { background: #fef2f2; border: 1px solid #fecaca; color: #991b1b; }
        ...
        .ticket-slot-btn.is-selected { background: var(--tc-blue); color: #fff; border-color: var(--tc-blue); }
        ...
        .ticket-employee-badge.ok { background: #dcfce7; color: #166534; border: 1px solid #bbf7d0; }
        .ticket-employee-badge.warning { background: #ffedd5; color: #9a3412; border: 1px solid #fed7aa; }
        .ticket-employee-badge.danger { background: #fee2e2; color: #991b1b; border: 1px solid #fecaca; }
        ...
        .tc-table-wrap table { margin-bottom: 0; }
        ...
        .ql-toolbar.ql-snow { border-radius: 12px 12px 0 0; border-color: var(--tc-border); }
        .ql-container.ql-snow { border-radius: 0 0 12px 12px; border-color: var(--tc-border); min-height: 420px; font-size: 15px; }
        ...
        .tc-submitbar small { color: var(--tc-muted); font-weight: 700; }
        .tc-danger-link { background: var(--tc-danger-light); color: #b91c1c; border-color: #fecaca; }
        .tc-danger-link:hover { background: #fee2e2; color: #991b1b; }

        .tc-modal .modal-content { border-radius: 16px; border: 1px solid var(--tc-border); box-shadow: var(--tc-shadow); overflow: hidden; }
        .tc-modal .modal-header { background: #fafafa; border-bottom: 1px solid var(--tc-border); }
        .tc-modal .modal-footer { background: #fafafa; border-top: 1px solid var(--tc-border); }
                ...
                <div class="tc-wrap">
                    <div class="tc-header">
                        <div class="tc-titlebar">
                            <div>
                                <h1 class="tc-title">Neues Ticket erstellen</h1>
                                <div class="tc-sub">Kunde, Produkt, Nuriva-Montage, Zuständigkeit und optionalen Termin in einem Workflow erfassen.</div>
                                <div class="tc-breadcrumb">
                                    <a href="{{ url('/employee_dashboard') }}">Home</a>
                                    <span>›</span>
                                    <a href="{{ url('problem_view') }}">Tickets</a>
                                    <span>›</span>
                                    <span class="current">Neu anlegen</span>
                                </div>
                            </div>
                    ...
                    <form class="wizard-circle" method="POST" action="{{ route('problem.store') }}" id="ticketCreateForm">
                        @csrf
                        <input type="hidden" name="start_user" value="{{ auth()->user()->name }}">
                        <input type="hidden" name="lead_stage_id" id="lead_stage_id" value="{{ old('lead_stage_id') }}" data-montage-stage-id="{{ $montageStageId }}">
                        <input type="hidden" name="lead_stage_sub_stage_id" id="lead_stage_sub_stage_id" value="{{ old('lead_stage_sub_stage_id') }}">
                        ...
                        <div class="tc-layout">
                            <div class="tc-main">
                                    ...
                                    <div class="tc-card-head">
                                        <div class="tc-card-titlebox">
                                            ...
                                            <div>
                                                ...
                                                <div class="tc-card-sub">Fehlercode, Quelle, Tickettyp, Datum und Priorität</div>
                                            </div>
                                        </div>
                                        <button type="button" class="tc-icon-btn tc-card-toggle"><i class="feather icon-chevron-up tc-collapse-icon"></i></button>
                                    </div>
                                    ...
                                    <div class="tc-card-body">
                                        <div class="tc-grid">
                                            <div class="tc-field tc-col-6">
                                                ...
                                                <select class="select2 form-control" multiple name="error_code[]" id="error_code"></select>
                                            ...
                                            <div class="tc-field tc-col-3">
                                                ...
                                                <select name="priority" id="periority" class="form-control select2">
                                                    <option value="normal" data-icon="fa fa-battery-empty">Keine</option>
                                                ...
                                                <div class="tc-check-panel">
                                                    <fieldset>
                                                        <div class="vs-checkbox-con vs-checkbox-primary">
                                                            <input type="checkbox" name="repeated" value="1" {{ old('repeated') ? 'checked' : '' }}>
                                                            <span class="vs-checkbox"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span>
                                                            <span class="font-weight-bold">Dieses Problem ist schon einmal aufgetreten</span>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tc-card-head">
                                        <div class="tc-card-titlebox">
                                            ...
                                            <div>
                                                ...
                                                <div class="tc-card-sub">Kundenprodukt wählen und optional automatisch auf Montage setzen</div>
                                            </div>
                                        </div>
                                        <button type="button" class="tc-icon-btn tc-card-toggle"><i class="feather icon-chevron-up tc-collapse-icon"></i></button>
                                    </div>
                                    ...
                                    <div class="tc-card-body">
                                        <div class="tc-grid">
                                            <div class="tc-field tc-col-6">
                                                ...
                                                <a href="{{ url('new_lead_create') }}" target="_blank" id="add-customer-btn" style="display:none; font-size:12px; font-weight:900; margin-bottom:6px;">
                                            ...
                                            <div class="tc-field tc-col-6">
                                                ...
                                                <input type="hidden" value="{{ old('alternative_id') }}" name="alternative_id" id="alternative_id">
                                                <input type="hidden" value="{{ old('lead_product_list_id') }}" name="lead_product_list_id" id="lead_product_list_id">
                                            ...
                                            <div class="tc-field tc-col-12">
                                                <div class="ticket-stage-card">
                                                    <div class="ticket-stage-title"><i class="feather icon-check-circle"></i> Nuriva Montage</div>

                                                    <div class="tc-switch-line">
                                                        <fieldset>
                                                            <div class="vs-checkbox-con vs-checkbox-primary">
                                                                <input type="checkbox" name="nuriva" id="nuriva" value="1" {{ $oldNuriva ? 'checked' : '' }}>
                                                                <span class="vs-checkbox"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span>
                                                                <span class="font-weight-bold">Nuriva</span>
                                                            </div>
                                                        </fieldset>
                                                        <small class="text-muted">Wenn aktiviert, wird das Ticket automatisch der CRM-Stage <b>Montage</b> zugeordnet.</small>
                                                    </div>

                                                    <div id="ticketStagePreview" class="mt-1">
                                                        <span class="text-muted">Stage wird nach Produktwahl oder Nuriva-Auswahl gesetzt.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tc-card-head">
                                        <div class="tc-card-titlebox">
                                            ...
                                            <div>
                                                ...
                                                <div class="tc-card-sub">Seriennummer, Installation, Gewährleistung und Kostenübernahme</div>
                                            </div>
                                        </div>
                                        <button type="button" class="tc-icon-btn tc-card-toggle"><i class="feather icon-chevron-up tc-collapse-icon"></i></button>
                                    </div>
                                    ...
                                    <div class="tc-card-body">
                                        <div class="tc-grid">
                                            <div class="tc-field tc-col-3">
                                                ...
                                                <input type="text" name="article_name" class="form-control" value="{{ old('article_name') }}">
                                                @error('article_name')<p class="text-danger">{{ $message }}</p>@enderror
                                            </div>
                                            <div class="tc-field tc-col-3">
                                                <label for="article_sn">Artikel Seriennummer</label>
                                                <input type="text" name="article_sn" class="form-control" value="{{ old('article_sn') }}">
                                            ...
                                            <div class="tc-field tc-col-3">
                                                ...
                                                @error('installation_date')<p class="text-danger">{{ $message }}</p>@enderror
                                            </div>
                                            <div class="tc-field tc-col-3">
                                            ...
                                            <div class="tc-field tc-col-4">
                                                ...
                                                <input type="number" name="warranty_remaining" class="form-control" min="0" value="{{ old('warranty_remaining') }}">
                                    ...
                                    <div class="tc-card-head">
                                        <div class="tc-card-titlebox">
                                            ...
                                            <div>
                                                ...
                                                <div class="tc-card-sub">Mitarbeiter auswählen und optional Verfügbarkeit prüfen</div>
                                            </div>
                                        </div>
                                        <button type="button" class="tc-icon-btn tc-card-toggle"><i class="feather icon-chevron-up tc-collapse-icon"></i></button>
                                    </div>
                                        ...
                                        <div class="tc-grid">
                                                ...
                                                <select class="select2 form-control" name="first_contact" id="first_contact">
                                                    @foreach($responsible as $res)
                                                        <option value="{{ $res->id }}" @if(auth()->user()->name == $res->id) selected @endif>
                                                            {{ $res->name }} {{ $res->lastname }} @if(auth()->user()->name == $res->id) (Aktueller Benutzer) @endif
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="tc-field tc-col-12">
                                                <div class="tc-check-panel">
                                                    <fieldset>
                                                        <div class="vs-checkbox-con vs-checkbox-primary">
                                                            <input type="checkbox" name="create_appointment" id="create_appointment" value="1" {{ old('create_appointment') ? 'checked' : '' }}>
                                                            <span class="vs-checkbox"><span class="vs-checkbox--check"><i class="vs-icon feather icon-check"></i></span></span>
                                                            <span class="font-weight-bold">Dieses Ticket automatisch als Termin erstellen</span>
                                                        </div>
                                                    </fieldset>
                                                    ...
                                                    <div id="appointment_fields" class="tc-grid mt-2" style="display:none;">
                                                        <div class="tc-field tc-col-3">
                                                            ...
                                                            <input type="date" name="appointment_date" id="appointment_date" class="form-control" value="{{ old('appointment_date', date('Y-m-d')) }}">
                                                        </div>
                                                        <div class="tc-field tc-col-3">
                                                            <label>Startzeit</label>
                                                            <input type="time" name="appointment_start_time" id="appointment_start_time" class="form-control" value="{{ old('appointment_start_time', '09:00') }}">
                                                        </div>
                                                        <div class="tc-field tc-col-3">
                                                            <label>Endzeit</label>
                                                            <input type="time" name="appointment_end_time" id="appointment_end_time" class="form-control" value="{{ old('appointment_end_time', '10:00') }}">
                                                        </div>
                                                        <div class="tc-field tc-col-3">
                                                            <label>Dauer</label>
                                                            <select name="appointment_duration_minutes" id="appointment_duration_minutes" class="form-control">
                                                        ...
                                                        <div class="tc-field tc-col-12">
                                                            <button type="button" class="tc-btn" id="check_ticket_appointment_availability">
                                                                <i class="feather icon-calendar"></i> Verfügbarkeit prüfen
                                                            </button>
                                                        </div>

                                                        <input type="hidden" name="appointment_checked" id="appointment_checked" value="0">
                                                        <input type="hidden" name="appointment_force" id="appointment_force" value="0">

                                                        <div class="tc-col-12">
                                                            <div class="ticket-availability-card">
                                                                <div class="ticket-availability-title"><i class="feather icon-calendar"></i> Mitarbeiter-Verfügbarkeit & freie Slots</div>
                                                                <div id="ticketAvailabilityResult">
                                                                    <div class="ticket-availability-alert is-warning">Bitte Datum und zuständige Mitarbeiter wählen, danach Verfügbarkeit prüfen.</div>
                                                                </div>
                                                                <div id="ticketAvailableSlots" class="ticket-slot-grid"></div>
                                                                <small class="text-muted d-block mt-1">Slots werden mit 20 Minuten Abstand zwischen den Terminen generiert.</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tc-card-head">
                                        <div class="tc-card-titlebox">
                                            ...
                                            <div>
                                                ...
                                                <div class="tc-card-sub">Problem, Ursache, Hinweise oder erste Diagnose</div>
                                            </div>
                                        </div>
                                        <button type="button" class="tc-icon-btn tc-card-toggle"><i class="feather icon-chevron-up tc-collapse-icon"></i></button>
                                    </div>
                                ...
                                <div class="tc-submitbar">
                                    <small><i class="feather icon-info"></i> Ticket wird mit Kunde, Produkt, Nuriva-Stage und optionalem Termin gespeichert.</small>
                                    <div class="tc-actions">
                                        <a type="button" class="tc-btn-soft tc-danger-link" href="{{ url('problem_view') }}">
                                ...
                                <div class="tc-card tc-card-collapsible">
                                    ...
                                    <div class="tc-card-body">
                                        <ul class="nav nav-pills nav-active-bordered-pill tc-history-tabs">
                                            <li class="nav-item"><a class="nav-link active" id="base-pill31" data-toggle="pill" href="#pill31" aria-expanded="true">Alte Tickets</a></li>
                                            <li class="nav-item"><a class="nav-link" id="base-pill32" data-toggle="pill" href="#pill32" aria-expanded="false">Alle Produkte</a></li>
                                        </ul>
                                            ...
                                            <div role="tabpanel" class="tab-pane active" id="pill31" aria-expanded="true" aria-labelledby="base-pill31">
                                                <div class="tc-table-wrap">
                                                    <table class="table table-bordered" id="old_ticket">
                                                        ...
                                                        <tbody>
                                                            <tr><td colspan="6" class="text-center text-muted">Kunde wählen...</td></tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                    ...
                    <div class="modal tc-modal" id="addErrorModal" tabindex="-1" role="dialog" aria-labelledby="addErrorModalLabel" aria-hidden="true">
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            Swal.fire({ icon: 'success', title: 'Erfolgreich', text: response.message || 'Ticket wurde gespeichert.' })
                                .then(function () { window.location.href = '/problem_view'; });
                        },
                        error: function (xhr) {
...
@push('scripts')
    <script>
        window.GlobalBreadcrumbs = [
            ...
            { label: 'Neu anlegen', url: "{{ url()->current() }}", clickable: false }
        ];
