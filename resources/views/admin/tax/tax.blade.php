...
@section('title')Steuereinstellung @stop
@section('content')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">STEUER INSTELLUNG</h2>
                    ...
                    <div class="col-12">
                        <div class="card"> 
                            <div class="card-content">
                                <div class="card-body"> 
                                <div class="col-9">
                                        <form action="{{action('App\Http\Controllers\TaxController@index')}}">
                                            <fieldset>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\TaxController@store')}}" class="custom-file-upload" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <fieldset> 
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        @if ($errors->has('tax'))<p style="color:red;">{!!$errors->first('tax')!!}</p>@endif
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        @if ($errors->has('remark'))<p style="color:red;">{!!$errors->first('remark')!!}</p>@endif
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </fieldset>
                                                ...
                                                <div class="modal fade text-left" id="delete-pro{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                              <a type="button" href="{{url('/tax_destroy').'/'.$item->id}}" class="btn btn-primary">Ja</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade text-left" id="editmodel{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\TaxController@update')}}">
                                                                @csrf
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                Steuer
                                                                                 ...
                                                                                 <input type="text" class="form-control"  name="tax" value="{{$item->tax}}"  required>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                Klass
                                                                                 ...
                                                                                 <input type="text" class="form-control"  name="class" value="{{$item->class}}"  required>
                                                                                 @if ($errors->has('class'))<p style="color:red;">{!!$errors->first('class')!!}</p>@endif
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label for="Title">
                                                                                 ...
                                                                                 <input type="text" class="form-control"  name="remark" value="{{$item->remark}}"  required>
                                                                                 @if ($errors->has('remark'))<p style="color:red;">{!!$errors->first('remark')!!}</p>@endif
                                                                            </div>
                                                                        </div>
                                                                       </div>
