      ...
      return `
        <div class="flex flex-col gap-1.5 mb-3 ${disabled ? 'opacity-50 pointer-events-none' : ''}">
          <div class="flex justify-between items-end">
            <label class="text-xs font-bold text-dark-600">${label}</label>
              ...
              ${state.wizardStep === 1 ? `
                <div class="space-y-6 animate-fade-in">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-white border border-slate-100 rounded-xl">
                    <div class="space-y-2">
                      <label class="text-sm font-semibold text-dark-600">Gebäudeart</label>
                    ...
                    ${config.gebaeudeArt === 'Einfamilienhaus' ? `
                      <div class="space-y-2">
                        <label class="text-sm font-semibold text-dark-600">Nutzungsart des Hauses</label>
                    ...
                    ` : `
                      <>
                        <div class="space-y-2">
                          <label class="text-sm font-semibold text-dark-600">Wohneinheiten gesamt</label>
                        ...
                        <div class="space-y-2">
                          <label class="text-sm font-semibold text-dark-600">Davon selbst bewohnt (Eigentümer)</label>
                      ...
                      ${config.kaminVorhanden ? `
                        <div class="space-y-3">
                          ...
                          <label class="flex items-center gap-2 cursor-pointer mt-2 pt-2 border-t border-slate-200">
                            ...
                            <span class="text-xs font-semibold text-dark-600">Wird im Neusystem weiter befeuert</span>
                          </label>
                        </div>
                      ` : ''}
                    </div>
                        ...
                        <div class="space-y-3">
                          ...
                          <label class="flex items-center gap-2 cursor-pointer mt-2 pt-2 border-t border-slate-200">
                            <input type="checkbox" ${config.solarthermieWeiterBetreiben ? 'checked' : ''}
                              ...
                              class="w-4 h-4 rounded" style="accent-color:${theme.primary}" />
                            <span class="text-xs font-semibold text-dark-600">Bleibt auf dem Dach / in Nutzung</span>
                          </label>
                        </div>
                      ` : ''}
                    </div>
                      ...
                      ` : `
                        <div class="space-y-2 p-4 border rounded-xl" style="border-color:${theme.secondary}50;background:${theme.bgLight}">
                          ...
                          <input type="number" min="0" max="${config.selbstbewohnteWE}" value="${config.weUnter40k}"
                            onchange="handleConfigChange('weUnter40k', Math.min(state.config.selbstbewohnteWE, Number(this.value)))"
                            class="w-full p-3 bg-white border border-slate-200 rounded-xl outline-none focus-ring" />
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2 relative">
                      ...
                      <input type="number" step="1000" value="${config.costWP}"
                        onchange="handleConfigChange('costWP', Number(this.value))"
                        class="w-full p-4 bg-white border border-slate-200 rounded-xl font-bold text-dark-600  outline-none focus-ring" />
                    </div>
                    ` : ''}
                    ...
                    <div class="space-y-2 relative">
                      ...
                      <input type="number" step="1000" value="${config.costPV}"
                        onchange="handleConfigChange('costPV', Number(this.value))"
                        class="w-full p-4 bg-white border border-slate-200 rounded-xl font-bold text-dark-600  outline-none focus-ring" />
                    </div>
                    ...
                    <div class="space-y-2 relative">
                      ...
                      <input type="number" step="500" value="${config.costBattery}"
                        onchange="handleConfigChange('costBattery', Number(this.value))"
                        class="w-full p-4 bg-white border border-slate-200 rounded-xl font-bold text-dark-600  outline-none focus-ring" />
                    </div>
                    ` : ''}
                    ...
                    <div class="space-y-2 relative">
                      ...
                      <input type="number" step="100" value="${config.costWallbox}"
                        onchange="handleConfigChange('costWallbox', Number(this.value))"
                        class="w-full p-4 bg-white border border-slate-200 rounded-xl font-bold text-dark-600  outline-none focus-ring" />
                    </div>
                    ` : ''}
                  </div>
              ...
              ${state.sidebarSections.kunde ? `
                <div class="p-4 border-t border-slate-100 bg-white">
                  <div class="flex flex-col gap-1.5 mb-3">
                    <label class="text-xs font-bold text-dark-600">Unternehmen / Design</label>
                  ...
                  ${config.moduleWP ? `
                  <div class="flex flex-col gap-1.5 mb-3">
                    <label class="text-xs font-bold text-dark-600">Gebäudeart</label>
                  ...
                  ${config.gebaeudeArt === 'Einfamilienhaus' ? `
                    <div class="flex flex-col gap-1.5 mb-3">
                      <label class="text-xs font-bold text-dark-600">Nutzung</label>
                  ...
                  ${config.dachseiten.map((dach) => `
                    <div class="flex gap-2 mb-3 pb-3 border-b border-slate-100 last:border-0 last:pb-0 last:mb-0 items-end flex-wrap">
                      ...
                      <div class="w-[20%]">
                        ...
                        <input type="number" value="${dach.neigung}" onchange="updateDachseite(${dach.id}, 'neigung', Number(this.value))" class="w-full p-2 border rounded-md text-xs outline-none" />
                      </div>
                      <div class="w-[25%]">
                        <label class="text-[13px] font-bold text-slate-500 mb-1 block">kWp</label>
                        <input type="number" step="0.1" value="${dach.customKwp || ''}" placeholder="Auto" onchange="updateDachseite(${dach.id}, 'customKwp', this.value)" class="w-full p-2 border rounded-md text-xs outline-none focus-ring" />
                      </div>
                      <div class="w-full flex gap-2 mt-1 items-end">
                        ...
                        <div class="flex-1">
                          ...
                          <input type="text" value="${dach.eindeckungTyp || ''}" onchange="updateDachseite(${dach.id}, 'eindeckungTyp', this.value)" placeholder="z.B. Beton" class="w-full p-2 border rounded-md text-xs outline-none" />
                        </div>
                        ${config.dachseiten.length > 1 ? `
            ...
            <div class="bg-white border border-slate-200 rounded-xl  overflow-hidden">
              ...
              ${state.sidebarSections.altsystem ? `
                <div class="p-4 border-t border-slate-100 bg-white">
                  ${config.moduleWP ? `
                  <div class="flex flex-col gap-1.5 mb-3">
                    <label class="text-xs font-bold text-dark-600">Hauptheizung</label>
                  ...
                  <div class="flex flex-col gap-1.5 mb-3 pt-3 border-t border-slate-100">
                    <label class="text-xs font-bold text-dark-600">Heizsystem (Übergabe)</label>
                  ...
                  <div class="flex gap-2 mb-3">
                    <div class="w-1/2">
                      <label class="text-xs font-bold text-dark-600 block mb-1.5">Warmwasser</label>
                    ...
                    <div class="w-1/2 flex items-center justify-center pt-5">
                      <label class="flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-xs font-bold text-dark-600">Zirkulation</span>
                      </label>
                    </div>
                  </div>

                  <div class="flex flex-col gap-1.5 mb-3">
                    <label class="text-xs font-bold text-dark-600">Rohrsystem Heizung</label>
                    <div class="flex gap-2">
                      ...
                      <input type="text" value="${config.rohrHeizungDN}" onchange="handleConfigChange('rohrHeizungDN', this.value)" placeholder="DN" class="w-1/3 p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-slate-600 focus-ring" />
                    </div>
                  </div>

                  <div class="flex flex-col gap-1.5 mb-3">
                    <label class="text-xs font-bold text-dark-600">Rohrsystem WW</label>
                    <div class="flex gap-2">
                      ...
                      <input type="text" value="${config.rohrWWDN}" onchange="handleConfigChange('rohrWWDN', this.value)" placeholder="DN" class="w-1/3 p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-slate-600 focus-ring" />
                    </div>
                  </div>

                  ${config.zirkulation ? `
                    <div class="flex flex-col gap-1.5 mb-3">
                      <label class="text-xs font-bold text-dark-600">Rohrsystem Zirkulation</label>
                      <div class="flex gap-2">
                        ...
                        <input type="text" value="${config.rohrZirkulationDN}" onchange="handleConfigChange('rohrZirkulationDN', this.value)" placeholder="DN" class="w-1/3 p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-slate-600 focus-ring" />
                      </div>
                    </div>
                  ` : ''}
                  ` : ''}
                  ...
                  ${config.moduleWB ? `
                  <div class="flex flex-col gap-1.5 mb-3 pt-3 border-t border-slate-100">
                    <label class="text-xs font-bold text-dark-600">Fahrzeug</label>
              ...
              ${state.sidebarSections.kaminSolar ? `
                <div class="p-4 border-t border-slate-100 bg-white">
                  <label class="flex items-center gap-2 cursor-pointer mb-2">
                    ...
                    <span class="text-xs font-bold text-dark-600">Kaminfeuer / Stückholz</span>
                  </label>
                  ${config.kaminVorhanden ? `
                    <div class="space-y-3">
                      <div class="flex gap-3">
                        <div class="w-1/2 space-y-1"><label class="text-xs text-slate-600">Bedarf (Raummeter)</label><input type="number" value="${config.holzVerbrauch}" onchange="handleConfigChange('holzVerbrauch', Number(this.value))" class="w-full p-2 border rounded-lg" /></div>
                        <div class="w-1/2 space-y-1"><label class="text-xs text-slate-600">Preis (€/RM)</label><input type="number" value="${config.preisHolz}" onchange="handleConfigChange('preisHolz', Number(this.value))" class="w-full p-2 border rounded-lg" /></div>
                      </div>
                      <label class="flex items-center gap-2 cursor-pointer mt-2 pt-2 border-t border-slate-200">
                  ...
                  <label class="flex items-center gap-2 cursor-pointer mb-2 mt-4 pt-4 border-t border-slate-100">
                    ...
                    <span class="text-xs font-bold text-dark-600">Solarthermie vorhanden</span>
                  </label>
                  ${config.solarthermieVorhanden ? `
                    <div class="space-y-3">
                      <div class="flex gap-3">
                        ...
                        <div class="w-1/2 space-y-1"><label class="text-xs text-slate-600">Anzahl Kollektoren</label><input type="number" value="${config.solarKollektoren}" onchange="handleConfigChange('solarKollektoren', Number(this.value))" class="w-full p-2 border rounded-lg" /></div>
                      </div>
                      <label class="flex items-center gap-2 cursor-pointer mt-2 pt-2 border-t border-slate-200">
        ...
        <div class="min-h-screen bg-slate-200 text-slate-600 font-sans pb-20 pt-16 print:p-0 print:bg-white relative overflow-x-hidden">
          ...
          <div class="w-full transition-all duration-300 print:m-0 ${state.isSidebarOpen ? 'md:mr-[360px] lg:mx-auto lg:translate-x-[-180px]' : ''}">
            ...
            <div class="a4-page flex flex-col relative bg-white overflow-hidden">
              ...
              <div class="space-y-3 text-[12px] leading-relaxed text-dark-600 mb-5 flex-1">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 mt-3">
                  ...
                  ${(() => {
                    const overviewItems = [
                      ...
                      config.modulePV ? ['Sonnenenergie:', 'Photovoltaik & Stromspeicher'] : null,
                    ...
                    return `
                      <div class="grid grid-cols-2 gap-x-6 text-[11px] text-dark-600">
                        <div class="space-y-2">
              ...
              <div class="mt-auto text-[12px] text-dark-600 leading-relaxed">
                <p class="mb-4">
            ...
            <div class="a4-page flex flex-col relative bg-white overflow-hidden">
              ...
              <div class="mb-3">
                <h3 class="text-1xl font-black mb-1 leading-tight" style="color:${theme.primary}">
                ...
                <p class="text-[13px] text-slate-600 leading-relaxed">
                  Um die wahre Effizienz unseres Konzepts zu verstehen, betrachten wir ${showMiddleStep ? 'drei' : 'zwei'} Szenarien: Ihr <strong>heutiges ${config.moduleWP ? 'fossiles ' : ''}System</strong>${showMiddleStep ? ', eine <strong>reine Elektrifizierung</strong> (ohne eigene Photovoltaik)' : ''} und die <strong>${theme.name} ${config.modulePV ? 'Lösung inkl. Photovoltaik' : 'Lösung'}</strong>.
                </p>
              </div>
              ...
              <div class="grid ${gridColsMiddle} gap-3 mb-3">
                <div class="bg-white border border-slate-200 rounded-xl p-3 flex flex-col">
                  ...
                  <div class="mt-auto pt-1.5 border-t border-slate-200 flex justify-between font-black text-dark-600 text-[13px]">
                ...
                <div class="bg-white border-2 rounded-xl p-3 flex flex-col" style="border-color:${theme.primary}">
                  ...
                  <table class="w-full text-left text-[8.5px] text-dark-600 mb-2">
                    <tbody>
                      ...
                      ` : ''}
                      <tr>
                        <td class="py-0.5">Wartung & Fixkosten<br><span class="text-[8.5px] text-slate-500">Pauschale</span></td>
                        <td class="text-right font-medium align-top py-0.5">${config.wartungOld} €</td>
                      </tr>
              ...
              <div class="bg-white border border-slate-200 rounded-xl overflow-hidden mb-auto flex flex-col">
                <div class="bg-white p-2.5 border-b border-slate-200">
                  <h4 class="font-bold text-[11px] flex items-center gap-2 mb-0.5" style="color:${theme.primary}">
                    <span class="w-4 h-4" style="color:${theme.primary}">${Icons.trendingUp()}</span>
                    Prognose der Kostenentwicklung (inkl. ${config.inflationRate}% Inflation/Jahr)
                  </h4>
                  ...
                  ${(() => {
                    ...
                    return `
                      <table class="w-full text-[9px] text-left">
                        ...
                        <tbody class="divide-y divide-slate-100 text-dark-600">
                          <tr>
              ...
              <div class="w-full bg-white p-3 rounded-xl border border-slate-200">
                  <div class="flex items-stretch gap-4">
                    ...
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div class="flex-1 min-w-0 space-y-1.5 text-[9px]">
                        <div class="flex justify-between items-center gap-3">
                          <span class="flex items-center gap-1.5 font-medium text-slate-600 min-w-0">
                            <div class="w-2 h-2 rounded-full shrink-0" style="background:${theme.inactive}"></div>
                            <span class="truncate">Haushalt</span>
                          </span>
                          <span class="font-bold text-slate-600 text-right shrink-0">
                    ...
                    <!-- RIGHT: KPI values -->
                    <div class="shrink-0 w-[260px] border-l border-slate-200 pl-4 flex items-center">
                      <div class="grid grid-cols-3 gap-3 w-full">
                        ${config.moduleWP ? `
                        <div class="text-center">
                          <span class="font-semibold text-slate-500 text-[9px] uppercase mb-1 block">Wärmepumpe</span>
                          <span class="font-black text-lg leading-none" style="color:${theme.primary}">
              ...
              <div class="flex items-end justify-between border-b border-slate-200 pb-1.5 mb-2">
                <div>
                  <h3 class="text-[13px] font-black text-[${theme.primary}] uppercase tracking-[0.16em] mb-1 mt-1">
                ...
                <div class="grid grid-cols-3 gap-3 mb-3">
                  <div class="bg-white border border-slate-200 rounded-xl px-3 py-2.5 flex flex-col items-center">
                    <div class="relative w-[94px] h-[94px] mb-2">
                      ...
                      <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <span class="text-[16px] font-black text-dark-600">${kpis.autarkie}%</span>
                      </div>
                    </div>
                    ...
                    <div class="text-center mb-1.5">
                      ...
                      <p class="text-[8.5px] text-slate-600 font-bold">Gesamte Bedarfsdeckung</p>
                    </div>
                    ...
                    <div class="w-full text-[7.5px] text-slate-600 space-y-1 border-t border-slate-300 pt-1.5">
                      ...
                      <div class="flex justify-between gap-2">
                        ...
                        <span class="font-bold text-dark-600">${formatDE(kpis.totalNetzbezug)} kWh</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-white border border-slate-200 rounded-xl px-3 py-2.5 flex flex-col items-center">
                    <div class="relative w-[94px] h-[94px] mb-2">
                      ...
                      <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <span class="text-[16px] font-black text-dark-600">${kpis.eigenverbrauchQuote}%</span>
                      </div>
                    </div>
                    ...
                    <div class="text-center mb-1.5">
                      ...
                      <p class="text-[8.5px] text-slate-600 font-bold">Nutzung des Solar-Stroms</p>
                    </div>
                    ...
                    <div class="w-full text-[7.5px] text-slate-600 space-y-1 border-t border-slate-300 pt-1.5">
                      ...
                      <div class="flex justify-between gap-2">
                        ...
                        <span class="font-bold text-dark-600">${formatDE(kpis.totalNetzeinspeisung)} kWh</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-white border border-slate-200 rounded-xl px-3 py-2.5 flex flex-col items-center">
                    <div class="relative w-[94px] h-[94px] mb-2">
                      ...
                      <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                        <span class="text-[16px] font-black text-dark-600">${finance.finUnabhProzent}%</span>
                      </div>
                    </div>
                    ...
                    <div class="text-center mb-1.5">
                      ...
                      <p class="text-[8.5px] text-slate-600 font-bold">Schutz vor Preisanstieg</p>
                    </div>
                    ...
                    <div class="w-full text-[7.5px] text-slate-600 space-y-1 border-t border-slate-300 pt-1.5">
                      <div class="flex justify-between gap-2">
                        ...
                        <span class="font-bold text-dark-600">+${formatDE(finance.ersparnisJahr1)} €</span>
                      </div>
                      <div class="flex justify-between gap-2">
                        <span class="flex items-center gap-1">
                          <div class="w-2 h-2 rounded-full" style="background:${theme.inactive}"></div>
                        ...
                        <span class="font-bold text-dark-600">${formatDE(Math.round(finance.costOldTotal))} €</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    return `
                      <div class="bg-white border border-slate-200 rounded-xl px-3 py-2.5 flex flex-col items-center">
                        <div class="relative w-[94px] h-[94px] mb-2">
                          ...
                          <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <span class="text-[16px] font-black text-dark-600">${pDeckung}%</span>
                          </div>
                        </div>
                        ...
                        <div class="text-center mb-1.5">
                          ...
                          <p class="text-[8.5px] text-slate-600 font-bold">Saisonale Deckung</p>
                        </div>

                        <div class="w-full text-[7.5px] text-slate-600 space-y-1 border-t border-slate-300 pt-1.5">
                          <div class="flex justify-between gap-2">
                            <span>Bedarf</span>
                            <span class="font-bold text-dark-600">${formatDE(total)} kWh</span>
                          </div>
                          ...
                          <div class="flex justify-between gap-2">
                            ...
                            <span class="font-bold text-dark-600">
            ...
            <div class="a4-page flex flex-col bg-white overflow-hidden">
              ...
              <h3 class="text-[11px] font-bold text-slate-600 mb-2 border-b border-slate-200 pb-1">
                ${theme.name} – Ihr Partner für die Energiewende
              </h3>
              ...
              <div class="space-y-2 flex-1">
                ...
                ${config.modulePV ? `
                  <div class="bg-white p-3 border border-slate-200 rounded-xl flex gap-3 items-center min-h-[64px]">
                    ...
                    <div>
                      <h4 class="font-bold text-slate-600 text-[13px] mb-0.5">Photovoltaik & Stromspeicher</h4>
                  ...
                  <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                    ...
                    <div class="mb-3">
                      ...
                      <p class="text-[10.5px] text-slate-600 leading-relaxed bg-white px-4 py-3 rounded-xl border border-slate-200">
                        <strong class="text-dark-600 block mb-0.5">Eine schlaue Entscheidung:</strong>
                        Solarstrom zum Eigenverbrauch ist die Energielösung der Zukunft. Mit einer Photovoltaikanlage nutzen Sie den erzeugten Strom tagsüber direkt. Unsere Systeme können durch einen Stromspeicher sinnvoll ergänzt werden, um die Eigenversorgung weiter zu steigern.
                      </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-3 mb-3">
                      <div class="rounded-xl p-4 border bg-white flex flex-col" style="border-color:${theme.secondary}50">
                        ...
                        <h3 class="text-[14px] font-black text-dark-600 mb-1.5 leading-snug">
                          Maximaler Nutzen durch Stromspeicher und Energiemanagement
                        </h3>

                        <p class="text-[10px] text-slate-600 leading-relaxed">
                          <strong class="text-dark-600 block mb-0.5">Effizienter geht’s nicht:</strong>
                          In Kombination mit einem Stromspeicher wird ein größerer Anteil Ihres Solarstroms direkt im eigenen Haus genutzt. Das steigert den Eigenverbrauch und reduziert die Abhängigkeit vom öffentlichen Netz deutlich.
                        </p>
                      ...
                      <div class="bg-white border border-slate-200 rounded-xl p-4 flex flex-col">
                        ...
                        <h3 class="text-[14px] font-black text-dark-600 mb-1.5 leading-snug uppercase tracking-[0.05em]">
                          Mehr Eigenverbrauch bringt mehr Unabhängigkeit
                        </h3>

                        <p class="text-[10px] text-slate-600 leading-relaxed">
                          <strong class="text-dark-600 block mb-0.5">Selbst produziert für die eigene Steckdose:</strong>
                    ...
                    <div class="mt-auto">
                      <div class="rounded-xl p-4 border relative overflow-hidden bg-white" style="border-color:${theme.primary}">
                        ...
                        <div class="relative z-10">
                          <h4 class="font-bold text-[11px] text-dark-600 mb-1.5 uppercase tracking-[0.08em]">
                            Ihr individuelles Dachpotenzial
                          </h4>

                          <p class="text-[10.2px] text-dark-600 leading-relaxed font-medium">
                            ${
                  ...
                  <div class="flex-1 pb-[22mm]">
                    ...
                    <div class="grid grid-cols-1 gap-3 mb-3">
                      <div class="bg-white border border-slate-200 rounded-xl p-3.5 flex flex-col">
                        ...
                        <h3 class="text-[14px] font-black text-dark-600 mb-1 leading-snug">
                    ...
                    <div class="bg-white border border-slate-200 rounded-xl p-3.5 flex flex-col gap-2.5">
                      <h3 class="font-bold text-[11px] text-dark-600 border-b border-slate-100 pb-1.5 flex items-center gap-2">
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                          <div>
                            <h4 class="text-[10px] font-bold text-dark-600 mb-0.5">
                        ...
                        <div class="flex flex-col justify-center">
                          <div class="flex justify-between items-end mb-1">
                            <span class="text-[10px] font-bold text-dark-600">
                          ...
                          <div class="flex w-full h-3.5 rounded-full overflow-hidden shadow-inner mb-1">
                            <div class="flex items-center justify-center text-[8.5px] text-dark-600 font-bold bg-slate-300" style="width:45%">45%</div>
                            <div class="flex items-center justify-center text-[8.5px] text-dark-600 font-bold" style="width:22%;background:${theme.secondary}">22%</div>
                            <div class="flex items-center justify-center text-[8.5px] text-white font-bold" style="width:8%;background:${theme.primary}">8%</div>
                            <div class="flex items-center justify-center text-[8.5px] text-white font-bold" style="width:25%;background:#64748b">25%</div>
                          </div>

                          <div class="grid grid-cols-4 gap-1 text-[8.5px] text-slate-600 font-medium">
                            <div class="text-center">
                ...
                <div class="a4-page flex flex-col bg-white relative overflow-hidden">
                  ...
                  <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                    ...
                    <div class="mb-3">
                      ...
                      <p class="text-[10.5px] text-slate-600 leading-relaxed bg-white px-4 py-3 rounded-xl border border-slate-200">
                        <strong class="text-dark-600 block mb-0.5">
                    ...
                    <div class="grid grid-cols-1 gap-3 mb-3">
                      <div class="rounded-xl p-4 border flex flex-col bg-white">
                        ...
                        <h4 class="text-[14px] font-black text-dark-600 mb-1.5 leading-snug">
                ...
                <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                  ...
                  <div class="grid grid-cols-1 gap-3 mb-4">
                    <div class="bg-white p-4 rounded-xl border border-slate-200">
                      ...
                      <h4 class="text-[14px] font-black text-dark-600 mb-1.5">
            ...
            <div class="a4-page flex flex-col bg-white overflow-hidden relative">
              ...
              <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                    ...
                    <table class="w-full text-[8px] text-left leading-tight">
                      <thead class="bg-white text-slate-500 text-[8px] uppercase tracking-[0.1em] border-b border-slate-100">
                        <tr>
                          ...
                          <th class="px-3 py-1.5 pr-4 font-black text-right text-dark-600">Netto</th>
                        </tr>
                      </thead>
                ...
                <div class="text-[8.5px] text-slate-500 mb-2.5 leading-relaxed shrink-0">
                  * <strong class="text-dark-600">Kombi-Bonus Bedingung:</strong>
                ...
                <div class="bg-white px-4 py-3 rounded-xl border border-slate-200 mb-2.5 shrink-0">
                  <h3 class="text-[10px] font-bold text-dark-600 mb-1">
              ...
              <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                ...
                <div class="space-y-2.5 flex-1 min-h-0">
                  ...
                  <div class="p-2.5 border border-slate-200 rounded-xl bg-white shrink-0">
                    <h3 class="font-bold text-dark-600 text-[10px] mb-1.5 flex items-center gap-2" style="color:${theme.primary}">
                    ...
                    <div class="grid grid-cols-2 gap-x-4 gap-y-1 text-[8.5px] text-dark-600">
                  ...
                  <div class="p-2.5 border border-slate-200 rounded-xl bg-white shrink-0">
                    ...
                    <div class="space-y-1 text-[8.5px] text-dark-600">
                      ...
                      <div class="bg-white p-2 border border-slate-200 rounded mt-1">
                        ...
                        <div class="text-[8.5px] mb-1 leading-relaxed text-dark-600">
                  ...
                  <div class="grid grid-cols-2 gap-2.5">
                    <div class="p-2.5 border border-slate-200 rounded-xl bg-white">
                      ...
                      <div class="bg-white p-2 border border-slate-200 rounded-lg">
                        ...
                        <div class="text-[8.5px] text-dark-600 font-bold mb-1.5 leading-relaxed">
                ...
                <div class="space-y-2.5 flex-1 min-h-0"> 
                  ...
                  <div class="grid grid-cols-2 gap-2.5">
                    <div class="p-2.5 border border-slate-200 rounded-xl bg-white">
                      ...
                      <div class="space-y-1.5 text-[8.5px] text-dark-600">
                        <div class="flex justify-between gap-3">
              ...
              <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                ...
                <div class="grid grid-cols-3 gap-3 mb-3">
                  <div class="flex flex-col items-center text-center px-1">
                    ...
                    <h4 class="font-bold text-dark-600 text-[10px] mb-1">Vor-Ort-Analyse</h4>
                  ...
                  <div class="flex flex-col items-center text-center relative px-1">
                    ...
                    <h4 class="font-bold text-dark-600 text-[10px] mb-1">Fördermittelservice</h4>
                    <p class="text-[8px] text-slate-600 leading-relaxed">
                  ...
                  <div class="flex flex-col items-center text-center relative px-1">
                    ...
                    <h4 class="font-bold text-dark-600 text-[10px] mb-1">Fachgerechte Installation</h4>
                    <p class="text-[8px] text-slate-600 leading-relaxed">
              ...
              <div class="flex-1 flex flex-col min-h-0 pb-[18mm]">
                ...
                <div class="border-2 bg-white px-4 py-4 rounded-2xl flex justify-between items-stretch gap-4 relative overflow-hidden mb-3"
                  ...
                  <div class="relative z-10 flex-1 pr-4 border-r border-slate-200 flex flex-col justify-center min-w-0">
                    ...
                    <div class="text-[8.5px] text-slate-400 font-medium mb-1.5 border-b border-slate-200 pb-1 inline-block leading-relaxed">
                  ...
                  <div class="relative z-10 flex-1 px-4 flex flex-col justify-center items-center text-center min-w-0">
                    <div class="text-[8.5px] font-bold tracking-[0.14em] uppercase mb-1 text-slate-500 leading-tight">
                    ...
                    <div class="text-[8.5px] font-bold text-slate-500 uppercase px-1 leading-relaxed">
                  ...
                  <div class="text-right relative z-10 pl-4 border-l border-slate-200 shrink-0 w-[150px] flex flex-col items-end justify-center">
                    ...
                    <div class="text-[9px] font-black text-[${theme.primary}] leading-tight uppercase tracking-[0.12em] mb-2">
                    ...
                    <div class="text-[8.5px] text-slate-500 space-y-0.5 leading-relaxed">
                      <p class="font-bold text-dark-600">Ansprechpartner: <span class="font-medium text-slate-600">Projektleitung</span></p>
                      <p>Tel.: ${theme.phone}</p>
                      <p>E-Mail: ${theme.email}</p>
                      <p>Web: ${theme.web}</p>
                      <p class="pt-1 mt-1 border-t border-slate-200/70">
                        Am Kappengraben 10</br>61273 Wehrheim
                      </p>
                    </div>
                  </div>
                </div>
