            ...
            <div class="p-8">
              ...
              ${state.wizardStep === 3 ? `
                <div class="space-y-6 animate-fade-in">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                      <label class="text-sm font-semibold">Aktuelle Nebenkosten (Wartung etc. €/Jahr)</label>
              ...
              <div class="flex justify-between mt-10 pt-6 border-t border-slate-100">
                <button onclick="setWizardStep(state.wizardStep - 1)"
                  ...
                  class="flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all ${state.wizardStep === 1 ? 'opacity-0 cursor-default' : 'bg-slate-100 text-dark-600 hover:bg-slate-200'}">
              ...
              ${state.sidebarSections.kunde ? `
                <div class="p-4 border-t border-slate-100 bg-white">
                  <div class="flex flex-col gap-1.5 mb-3">
                    ...
                    <select onchange="handleConfigChange('company', this.value)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                      <option ${config.company === 'Werkstudio' ? 'selected' : ''}>Werkstudio</option>
                      <option ${config.company === 'Solar Aspekt' ? 'selected' : ''}>Solar Aspekt</option>
                    </select>
                  </div>
                  ...
                  <div class="flex flex-col gap-1.5 mb-3">
                    ...
                    <select onchange="handleConfigChange('gebaeudeArt', this.value)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                      <option ${config.gebaeudeArt === 'Einfamilienhaus' ? 'selected' : ''}>Einfamilienhaus</option>
                      <option ${config.gebaeudeArt === 'Mehrfamilienhaus' ? 'selected' : ''}>Mehrfamilienhaus</option>
                    </select>
                  </div>
                  ...
                  ${config.gebaeudeArt === 'Einfamilienhaus' ? `
                    <div class="flex flex-col gap-1.5 mb-3">
                      ...
                      <select onchange="handleConfigChange('selbstbewohnteWE', this.value === 'Selbstbewohnt' ? 1 : 0)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                        <option ${config.selbstbewohnteWE === 1 ? 'selected' : ''}>Selbstbewohnt</option>
                        <option ${config.selbstbewohnteWE !== 1 ? 'selected' : ''}>Vermietet</option>
                      </select>
                    </div>
              ...
              ${state.sidebarSections.altsystem ? `
                <div class="p-4 border-t border-slate-100 bg-white">
                  ...
                  <div class="flex flex-col gap-1.5 mb-3">
                    ...
                    <select onchange="handleConfigChange('heizungArt', this.value)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                      ${['Gas','Öl','Holz / Pellets','Nachtspeicher'].map(opt => `
                        <option ${config.heizungArt === opt ? 'selected' : ''}>${opt}</option>
                      `).join('')}
                    </select>
                  ...
                  <div class="flex flex-col gap-1.5 mb-3 pt-3 border-t border-slate-100">
                    ...
                    <select onchange="handleConfigChange('heizSystem', this.value)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                      ${['Heizkörper','Fußbodenheizung','Beides'].map(opt => `
                        <option ${config.heizSystem === opt ? 'selected' : ''}>${opt}</option>
                      `).join('')}
                    </select>
                  ...
                  <div class="flex gap-2 mb-3">
                    <div class="w-1/2">
                      ...
                      <select onchange="handleConfigChange('warmwasserArt', this.value)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                  ...
                  <div class="flex flex-col gap-1.5 mb-3">
                    ...
                    <div class="flex gap-2">
                      <select onchange="handleConfigChange('rohrHeizungMaterial', this.value)" class="w-2/3 p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                        ${['Kupfer','Eisenrohr','Kunststoff','Verbundrohr','Edelstahl'].map(opt => `
                          <option ${config.rohrHeizungMaterial === opt ? 'selected' : ''}>${opt}</option>
                        `).join('')}
                      </select>
                  ...
                  <div class="flex flex-col gap-1.5 mb-3">
                    ...
                    <div class="flex gap-2">
                      <select onchange="handleConfigChange('rohrWWMaterial', this.value)" class="w-2/3 p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                        ${['Kupfer','Eisenrohr','Kunststoff','Verbundrohr','Edelstahl'].map(opt => `
                          <option ${config.rohrWWMaterial === opt ? 'selected' : ''}>${opt}</option>
                        `).join('')}
                      </select>
                  ...
                  ${config.zirkulation ? `
                    <div class="flex flex-col gap-1.5 mb-3">
                      ...
                      <div class="flex gap-2">
                        <select onchange="handleConfigChange('rohrZirkulationMaterial', this.value)" class="w-2/3 p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                          ${['Kupfer','Eisenrohr','Kunststoff','Verbundrohr','Edelstahl'].map(opt => `
                            <option ${config.rohrZirkulationMaterial === opt ? 'selected' : ''}>${opt}</option>
                          `).join('')}
                        </select>
                  ...
                  <div class="flex flex-col gap-1.5 mb-3 pt-3 border-t border-slate-100">
                    ...
                    <select onchange="handleConfigChange('autoArt', this.value)" class="w-full p-2 bg-white border border-slate-200 rounded-lg outline-none text-sm font-medium text-dark-600 focus-ring">
                      <option ${config.autoArt === 'Verbrenner' ? 'selected' : ''}>Verbrenner</option>
                      <option ${config.autoArt === 'E-Auto' ? 'selected' : ''}>E-Auto</option>
                    </select>
                  </div>
              ...
              ${state.sidebarSections.kaminSolar ? `
                <div class="p-4 border-t border-slate-100 bg-white">
                  ...
                  ${config.kaminVorhanden ? `
                    <div class="space-y-3">
                      <div class="flex gap-3">
                        <div class="w-1/2 space-y-1"><label class="text-xs text-dark-600">Bedarf (Raummeter)</label><input type="number" value="${config.holzVerbrauch}" onchange="handleConfigChange('holzVerbrauch', Number(this.value))" class="w-full p-2 border rounded-lg" /></div>
                        <div class="w-1/2 space-y-1"><label class="text-xs text-dark-600">Preis (€/RM)</label><input type="number" value="${config.preisHolz}" onchange="handleConfigChange('preisHolz', Number(this.value))" class="w-full p-2 border rounded-lg" /></div>
                      </div>
                      <label class="flex items-center gap-2 cursor-pointer mt-2 pt-2 border-t border-slate-200">
                  ...
                  ${config.solarthermieVorhanden ? `
                    <div class="space-y-3">
                      <div class="flex gap-3">
                        ...
                        <div class="w-1/2 space-y-1"><label class="text-xs text-dark-600">Anzahl Kollektoren</label><input type="number" value="${config.solarKollektoren}" onchange="handleConfigChange('solarKollektoren', Number(this.value))" class="w-full p-2 border rounded-lg" /></div>
                      </div>
                      <label class="flex items-center gap-2 cursor-pointer mt-2 pt-2 border-t border-slate-200">
                      ...
                      <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col justify-center">
                          ...
                          <div class="flex w-full h-3.5 rounded-full overflow-hidden shadow-inner mb-1">
                            <div class="flex items-center justify-center text-[8.5px] text-white font-bold bg-slate-300" style="width:45%">45%</div>
                            <div class="flex items-center justify-center text-[8.5px] text-white font-bold" style="width:22%;background:${theme.secondary}">22%</div>
                      ...
                      <div class="space-y-1.5 text-[8.5px] text-slate-700">
                        ...
                        <div class="bg-white p-2 border border-slate-200 rounded-lg mt-0.5 space-y-1">
                          ...
                          <div class="flex justify-between gap-3">
                            ...
                            <strong class="shrink-0">160 €/Jahr</strong>
                          </div>

                          <div class="flex justify-between gap-3">
                            <span>Modul 2 (60% auf Netzbezug):</span>
                            <strong class="shrink-0">${Math.round((finance.wpNetz + finance.evNetz) * config.netzentgelt * 0.6).toLocaleString('de-DE')} €/Jahr</strong>
                          </div>
