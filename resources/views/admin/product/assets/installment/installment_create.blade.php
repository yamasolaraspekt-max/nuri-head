                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" class="form-control" name="asset_id"
                                                            value="{{ $asset->id }}" required>
                                                        <input type="text" class="form-control" name="asset_name"
                                                            value={{ request()->type == 'asset' ? $asset->item :
                                                        ($asset->name . ' ' . $asset->model) }} disabled required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('item'))<p style="color:red;">
                                                            {!!$errors->first('item')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="purchased_from"
                                                            value="{{ old('purchased_from') }}" required>
                                                        @if ($errors->has('purchased_from'))<p style="color:red;">
                                                            {!!$errors->first('purchased_from')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('price_per_month'))<p style="color:red;">
                                                            {!!$errors->first('price_per_month')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control currency-input"
                                                            id="fines" name="fines" value="{{ old('fines') }}" required>
                                                        @if ($errors->has('fines'))<p style="color:red;">
                                                            {!!$errors->first('fines')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            name="installment_duration" id="installment_duration"
                                                            value="{{ old('installment_duration') }}" required>
                                                        @if ($errors->has('installment_duration'))<p style="color:red;">
                                                            {!!$errors->first('installment_duration')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('due_date'))<p style="color:red;">
                                                            {!!$errors->first('due_date')!!}</p>@endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <select
                                                                ...
                                                                name="paid_by" id="paid_by" style="width:100%">
                                                                <option value="{{ old('paid_by') }}">{{ old('paid_by')
                                                                    }}</option>
                                                        ...
                                                        @if ($errors->has('paid_by'))<p style="color:red;">
                                                            {!!$errors->first('paid_by')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 kauf">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ old('insurance_provider') }}" required>
                                                        @if ($errors->has('insurance_provider'))<p style="color:red;">
                                                            {!!$errors->first('insurance_provider')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 kauf">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control currency-input"
                                                            ...
                                                            value="{{ old('insurance_amount') }}" required>
                                                        @if ($errors->has('insurance_amount'))<p style="color:red;">
                                                            {!!$errors->first('insurance_amount')!!}</p>@endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6 kauf">
                                                    <div class="form-group">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <select
                                                                class="select2-customize-result form-control required"
                                                                name="insurance_payment_month"
                                                                id="insurance_payment_month" style="width:100%">
                                                                <option value="" selected>select the Month/Year</option>
                                                                <option value="3 Monaten">3 Monaten</option>
                                                                <option value="6 Monaten">6 Monaten</option>
                                                                <option value="Jahr">Jahr</option>
                                                            </select>
                                                        </fieldset>
                                                        @if ($errors->has('insurance_payment_month'))<p
                                                            style="color:red;">
                                                            {!!$errors->first('insurance_payment_month')!!}</p>@endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 kauf">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('insurance_expiry_date'))<p
                                                            style="color:red;">
                                                            {!!$errors->first('insurance_expiry_date')!!}</p>@endif
                                                    </div>
                                                </div>
