            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                            ...
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $item->item }} - <code>{{ $item->installment_id }}</code>
                                            <br>
                        ...
                        <a type="button" href="{{ url('/asset_installment_append/'.$item->id) }}"
                            class="btn btn-icon btn-icon rounded-circle btn-success mr-1 mb-1">
                        ...
                        <td>
                            ...
                            <a type="button" href="{{ url('/handover/'.$item->id) }}"
                                class="btn btn-icon btn-icon rounded-circle btn-success mr-1 mb-1">
                                <i class="feather icon-check"></i>
                            </a>
                            @else
                            <a type="button" href="{{ url('/unpublish/'.$item->id) }}"
                                class="btn btn-icon btn-icon rounded-circle btn-danger mr-1 mb-1">
                                <i class="feather icon-check"></i>
                            </a>
                            @endif
