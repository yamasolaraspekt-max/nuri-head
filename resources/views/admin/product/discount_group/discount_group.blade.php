...
@section('title')Rabattgruppe @stop
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Rabattgruppe: </h4>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="col-9">
                                        <form action="{{action('App\Http\Controllers\DiscountGroupController@index')}}">
                                            <fieldset>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\DiscountGroupController@store')}}" class="custom-file-upload" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <fieldset> 
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="Title">
                                                                                            Titel der Rabattgruppe
                                                                                        </label>
                                                                                    
                                                                                        <input type="text" class="form-control"  name="discount_group"  required>
                                                                                        @if ($errors->has('discount_group'))<p style="color:red;">{!!$errors->first('discount_group')!!}</p>@endif
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="number" class="form-control"  name="discount"  required placeholder="%">
                                                                                        @if ($errors->has('discount'))<p style="color:red;">{!!$errors->first('discount')!!}</p>@endif
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <div class="modal fade text-left" id="delete-pro{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                              <a type="button" href="{{url('/discount_group_destroy').'/'.$item->id}}" class="btn btn-primary">Ja</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade text-left" id="editmodel{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\DiscountGroupController@update')}}">
                                                                @csrf
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                Rabbatgroup
                                                                                 ...
                                                                                 <input type="text" class="form-control"  name="discount_group" value="{{$item->discount_group}}"  required>
