                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" disabled  class="form-control" value="{{ $data->brand }}" name="new_brand" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="product" disabled class="form-control" value="{{ $data->product }}" name="product" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="model" disabled class="form-control" value="{{ $data->model }}" name="model" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-8">
                                                                <input type="text" id="model" disabled class="form-control" value="{{ $data->distributor }}" name="model" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-8">
                                                                <input type="text" id="model" disabled class="form-control" value="{{ $data->used }}" name="model" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12" id="customer" >
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="model" disabled class="form-control" value="{{ $data->name }} " name="model" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-md-8">
                                                                <fieldset class="form-group">
                                                                    <select class="select2-customize-result form-control" name="problem_id"  id="problem_id"  style="width:100%">
                                                                        ...
                                                                        <input type="text" id="model" disabled class="form-control" value="Ticket" name="model" required>
                                                                    </select>
                                                                </fieldset>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-8">
                                                            <input type="text" id="model" disabled class="form-control" value="{{ $data->color }}" name="model" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-8">
                                                                <input type="text" id="model" disabled class="form-control" value="{{ $data->measure_unit }}" name="model" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-8">
                                                                <input type="text" id="price_unit" class="form-control" disabled value="{{ $data->price_unit }}" name="price_unit" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <fieldset>
                                                            <div id="editor" class="form-control"  style="height: 400px !important; -webkit-user-modify:read-only;" disabled >
                                                                {!! $data->short_description !!}
                                                            </div>
                                                            <textarea name="editor_text" disabled class="form-control"  hidden id="editor_text"  cols="30" rows="10">{!! $data->short_description !!}</textarea>
                                                    </fieldset>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="number" id="retail_price" class="form-control" disabled value="{{ $data->retail_price }}" name="retail_price" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" id="retail_price" disabled class="form-control" value="{{ $data->retail_discount_type }}" name="retail_price" required>

                                                            </div>

                                                            <div class="col-md-2" id="euro_text" >
                                                                <input type="number" class="form-control required" disabled placeholder="Euro" id="r_discount_e"  value="{{ $data->retail_discount }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="purchase_price"  disabled ="form-control" value="{{ $data->purchase_price}}" name="purchase_price" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="quantity" disabled class="form-control" value="{{ $data->quantity }}" name="quantity" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-8">
                                                                ...
                                                                <fieldset class="form-group">
                                                                    <select class="select2-customize-result form-control required" disabled name="request_from"  id="request_from"  style="width:100%">
                                                                        @foreach ($employee as $emp)
                                                                        <option value="{{ $emp->id }}" @if($emp->id=$data->request_from) selected @endif>{{ $emp->name }} {{ $emp->lastname }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </fieldset>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-8">
                                                                ...
                                                                <fieldset class="form-group">
                                                                    <select class="select2-customize-result form-control required" disabled name="request_to"  id="request_to"  style="width:100%">
                                                                        @foreach ($employee as $emp)
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" id="link" disabled class="form-control" value="{{ $data->link }}" name="link" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <img src="{{ asset('images/purchase/'.$data->image) }}"  width="400px" height="auto">
                                                            </div>
                                                        </div>
                                                    </div>
