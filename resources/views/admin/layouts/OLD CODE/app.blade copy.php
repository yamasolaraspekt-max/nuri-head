                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            ...
                            <li class="nav-item d-none d-lg-block">
                                 <div class="btn-group dropup dropdown-icon-wrapper mt-1  d-lg-block"  > 
                                    <button type="button" class="btn  dropdown-toggle dropdown-toggle-split waves-effect waves-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="ficon feather icon-check-square"></i> AUFGABEN
                                    </button>
                            ...
                            <li class="nav-item d-none d-lg-block">
                                 <div class="btn-group dropup dropdown-icon-wrapper mt-1"  > 
                                    <button type="button" class="btn  dropdown-toggle dropdown-toggle-split waves-effect waves-light" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="ficon feather icon-calendar"></i> KALENDER
                                    </button>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="#"><i class="feather icon-home"></i>
                <span class="menu-title" data-i18n="Dashboard">DASHBOARD</span>
                <span class="badge badge badge-warning badge-pill float-right mr-2">2</span></a>
                    <ul class="menu-content">
                        <li class="active"><a href="{{ url('/home') }}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Analytics">HOME</span></a>
                        </li> 
                    </ul>
                </li> 
                 <li class="navigation-header"><span>Apps</span></li>
                    <li class="nav-item">
                        ...
                        <ul class="menu-content"> 
                             <li class="has-sub">
                                <a href="#"><i class="fa fa-folder"></i>ANFRAGE</a>
                                <ul class="menu-content">
                                    <li><a href="{{ route('problem.create') }}"><i class="fa fa-plus-square-o"></i>ANFRAGE ANLEGEN</a></li>
                                    <li><a href="{{ route('problem.view') }}"><i class="feather icon-menu"></i>ANFRAGELISTE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>JUNK ANFRATE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-settings"></i>ANFRATE KONTAKTS ART</a></li>
                                    <li><a href="{{ route('error.info') }}" class="danger"><i class="feather icon-trash"></i> GELÖSCHTE ANFRAGEN</a></li>
                                </ul>
                            </li>
                            <li class="has-sub">
                                <a href="#"><i class="fa fa-folder"></i>LEAD</a>
                                <ul class="menu-content">
                                    <li><a href="{{ route('problem.create') }}"><i class="fa fa-plus-square-o"></i>LEAD ANLEGEN</a></li>
                                    <li><a href="{{ route('problem.view') }}"><i class="feather icon-menu"></i>NEUE LEADS</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>MEINE LEADS</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>LEADLISTE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>FREIE LEADS</a></li> 
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>JUNK LEADS</a></li> 
                                    <li><a href="{{ route('error.info') }}" class="danger"><i class="feather icon-trash"></i> GELÖSCHTE LEADS</a></li>
                                </ul>
                            </li>

                            <li class="has-sub">
                                <a href="#"><i class="fa fa-folder"></i>PLANUNG</a>
                                <ul class="menu-content"> 
                                    <li><a href="{{ route('problem.view') }}"><i class="feather icon-menu"></i>NEUE PLANUNG</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>OFFENE PLANUNG</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>FERTIGE PLANUG</a></li> 
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>ALLE PLANUNG</a></li> 
                                    <li><a href="{{ route('error.info') }}" class="danger"><i class="feather icon-trash"></i> GELÖSCHTE PLANUNG</a></li>
                                </ul>
                            </li>

                            <li class="has-sub">
                                <a href="#"><i class="fa fa-folder"></i>ANGEBOTE</a>
                                <ul class="menu-content"> 
                                    <li><a href="{{ route('problem.view') }}"><i class="feather icon-menu"></i>NEUE ANGEBOTE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>OFFENE ANGEBOTE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>FERTIGE ANGEBOTE</a></li> 
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>ANGEBOTS BESCHPRECHUNG</a></li> 
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>ANGEBOTS STATUS</a></li> 
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>ALLE ANGEBOTE</a></li> 
                                    <li><a href="{{ route('error.info') }}" class="danger"><i class="feather icon-trash"></i> GELÖSCHTE ANGEBOTE</a></li>
                                </ul>
                            </li>
                            <li class="has-sub">
                                <a href="#"><i class="fa fa-folder"></i>AUFTRÄGE</a>
                                <ul class="menu-content"> 
                                    <li><a href="{{ route('problem.view') }}"><i class="feather icon-menu"></i>NEUE AUFTRÄGE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>UNBESTÄTIGTE AUFTRÄGE</a></li>
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>BESTÄTIGTE AUFTRÄGE</a></li>   
                                    <li><a href="{{ route('error.info') }}"><i class="feather icon-slash"></i>ALLE AUFTRÄGE </a></li> 
                                    <li><a href="{{ route('error.info') }}" class="danger"><i class="feather icon-trash"></i> GELÖSCHTE ANGEBOTE</a></li>
                                </ul>
                            </li>
                            <li class="has-sub">
                                <a href="#"><i class="feather icon-folder"></i>PROJEKTE</a>
                                <ul class="menu-content">
                                    <li><a href="{{ route('customer.create') }}"><i class="feather icon-user-plus"></i>PROJEKTE ANLEGEN</a></li>
                                    <li><a href="{{ route('customer.details') }}"><i class="feather icon-user"></i>NEUES PROJEKT</a></li>
                                    <li><a href="{{ route('customer.details') }}"><i class="feather icon-user"></i>MEINE PROJEKTE</a></li>
                                    <li><a href="{{ route('customer.details') }}"><i class="feather icon-user"></i>ALLE PROJEKTE</a></li>
                                    <li><a href="{{ route('customer.details') }}"><i class="feather icon-user"></i>JUNK PROJEKTE</a></li> 
                                    <li><a href="{{ route('customer.details') }}"><i class="feather icon-user"></i>GELÖSCHTE PROJEKTE</a></li> 
                                    <li class="has-sub">
                                        <a href="#"><i class="feather icon-user"></i>Kunden-Home-Einstellung</a>
                                        <ul class="menu-content">
                                            <li><a href="{{ route('building.type.view') }}"><i class="feather icon-circle"></i>Gebäudeart</a></li>
                                            <li><a href="{{ route('heating.type.view') }}"><i class="feather icon-circle"></i>Heizungsart</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="has-sub">
                                <a href="#"><i class="feather icon-folder"></i>Angebot</a>
                                <ul class="menu-content">
                                    <li class="has-sub">
                            ...
                            <li><a href=""><i class="feather icon-file"></i>Aufträge</a></li>
                                    ...
                                    <li class="has-sub">
                                        ...
                                        <ul class="menu-content">
                                            ...
                                            <li class="has-sub">
                                                ...
                                                <ul class="menu-content">
                                                    <li><a href="{{ route('task.phase.details') }}"><i class="feather icon-list"></i>Arbeitsschritte Details</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <li class="navigation-header"><span>Personal</span></li>
                    <li class="nav-item">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="{{ url('new_lead_view') }}">
                                                    <i class="fa fa-list-ol"></i> LEADLISTE
                                                </a>
                                            </li>

                                            <li>
                                                <a href="{{ url('new_lead_view') }}" class="danger">
                                                    <i class="feather icon-user-x"></i> FREIE LEADS
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="{{ url('lead_junks') }}">
                                                    <i class="feather icon-trash-2"></i> JUNK LEAD
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
 ...
 <!-- END: Circle Menu-->
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix blue-grey lighten-2 mb-0"><span
                class="float-md-left d-block d-md-inline-block mt-25">asd &copy; {{ $year }}<a
