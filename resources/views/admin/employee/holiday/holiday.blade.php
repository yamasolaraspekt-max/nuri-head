                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Feiertage</h4>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="col-9">
                                        <form action="{{action('App\Http\Controllers\HolidayController@index')}}">
                                            <fieldset>
                                ...
                                <div class="col-md-3 float-right">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\HolidayController@store')}}" class="custom-file-upload" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <fieldset> 
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control"  name="holiday" value="{{ old('holiday') }}" required>
                                                                                        @if ($errors->has('holiday'))<p style="color:red;">{!!$errors->first('holiday')!!}</p>@endif
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </fieldset>
                                                ...
                                                <div class="modal fade text-left" id="delete-pro{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                              <a type="button" href="{{url('/holiday_destroy').'/'.$item->id}}" class="btn btn-primary">Yes</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade text-left" id="editmodel{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\HolidayController@update')}}">
                                                                @csrf
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"  name="holiday" value="{{ $item->holiday }}"  required>
                                                                                @if ($errors->has('holiday'))<p style="color:red;">{!!$errors->first('holiday')!!}</p>@endif
                                                                            </div>
                                                                        </div>
                                    ...
                                    <a type="button" href="{{ url('holiday_active/'.$item->id) }}"    class="btn btn-icon btn-icon rounded-circle btn-success mr-1 mb-1" >
                                        <i class="feather icon-check"></i>
                                        </a>
                                    @else
                                    <a type="button" href="{{ url('holiday_deactive/'.$item->id) }}"    class="btn btn-icon btn-icon rounded-circle btn-danger mr-1 mb-1" >
