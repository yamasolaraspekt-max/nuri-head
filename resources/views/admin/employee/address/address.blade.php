...
@section('title') Employee Address @stop
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="col-9">
                                        <form action="{{action('App\Http\Controllers\EmployeeAddressController@index')}}">
                                            <fieldset>
                                        ...
                                        <div class="modal fade text-left" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\ContractTypeController@store')}}" class="custom-file-upload" enctype="multipart/form-data">
                                                                @csrf
                                                                <fieldset> 
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="Title">
                                                                                 ...
                                                                                 @if ($errors->has('contract_type'))<p style="color:red;">{!!$errors->first('contract_type')!!}</p>@endif
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="Title">
                                                                                   Duration <strong><code>.OPTIONAL</code></strong>
                                                                                </label>
                                        ...
                                        <div class="modal fade text-left" id="editmodel{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\ContractTypeController@update')}}">
                                                                @csrf
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-group">
                                                                                <label for="Title">
                                                                                 ...
                                                                                 <input type="text" class="form-control"  name="contract_type" value="{{$item->contract_type}}"  required>
                                                                             ...
                                                                             <div class="col-md-6">
                                                                                   <div class="form-group">
                                                                                    ...
                                                                                    <label for="" >
                                                                                        ...
                                                                                        <input type="text" class="form-control"  name="duration" value="{{$item->contract_duration}}"  placeholder="" required>
                                                                                 @if ($errors->has('duration'))<p style="color:red;">{!!$errors->first('duration')!!}</p>@endif
