                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Lohn Vollkosten</h4>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="col-9">
                                        <form action="{{action('App\Http\Controllers\SalaryController@index')}}">
                                            <fieldset>
                                  ...
                                  <div class="col-md-3 float-right">
                                        <div class="card-body">
                                            <a type="button" class="btn btn-outline-primary block btn-lg" href="{{ url('refresh_salary') }}">
                                                Aktualisierung
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-striped mb-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Produktivstunden</th>
