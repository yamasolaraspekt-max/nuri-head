...
@section('title') Heizungsart:@stop
@section('content')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Heizungsart:</h4>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="col-9">
                                        <form action="{{action('App\Http\Controllers\HeatingTypeController@index')}}">
                                            <fieldset>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\HeatingTypeController@store')}}" class="custom-file-upload" enctype="multipart/form-data">
                                                                        @csrf
                                                                        <fieldset> 
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" class="form-control"  name="heating_type"  required>
                                                                                        @if ($errors->has('heating_type'))<p style="color:red;">{!!$errors->first('heating_type')!!}</p>@endif
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            <thead>
                                                <tr>
                                                    <th scope="col">ID</th>
                                                    <th scope="col">Heizungsart:</th>
                                                    <th scope="col">Wertnummer:</th>
                                                ...
                                                <div class="modal fade text-left" id="delete-pro{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                              <a type="button" href="{{url('heating_type_destroy/'.$item->id)}}" class="btn btn-primary">Yes</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal fade text-left" id="editmodel{{$item->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form class="form-horizontal" novalidate method="post" action="{{action('App\Http\Controllers\HeatingTypeController@update')}}">
                                                                @csrf
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label for="Title">
                                                                                    Heizungsart:                                                                                </label>
                                                                                 <input type="text" class="form-control"  name="heating_type" value="{{$item->heating_type}}"  required>
