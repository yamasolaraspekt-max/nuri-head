...
} from "../geometry/dachformVorlagen";
...
import {
  ...
  type AufbauWunsch,
} from "../geometry/aufbauPlatzierung";
import {
  platziereSchneefang,
  sperrzoneVRel,
  istInSperrzone,
...
} from "../geometry/grundriss";
import { oeffnungRechteck, oeffnungVTiefeM } from "../geometry/dachOeffnung";
import {
  stehendeAufbauBasis,
  istStehenderAufbau,
} from "../geometry/aufbauOrientierung";
...
test("Reinheit: dachformVorlagen.ts importiert kein react/three und nutzt keine DOM/THREE-Symbole", () => {
  const pfad = fileURLToPath(new URL("../geometry/dachformVorlagen.ts", import.meta.url));
