...
const engineFaehigkeiten: Faehigkeit[] = [
  { id: 'engine-fbh', label: 'Fußbodenheizung-Auslegung', gruppe: 'tga-heizung', art: 'engine', zustand: 'verfuegbar', funktion: 'Heizfläche, Rohrlänge, Heizkreise', eingang: 'FbhEingabe', ausgang: 'FbhErgebnis', engineModul: 'geometry/fbhAuslegung', engineExport: 'fbhAuslegung' },
  { id: 'engine-heizkoerper', label: 'Heizkörper-Leistung', gruppe: 'tga-heizung', art: 'engine', zustand: 'verfuegbar', funktion: 'Über-/Unterdeckung nach EN 442', eingang: 'Normleistung + Betriebsbedingung', ausgang: 'DeckungErgebnis', engineModul: 'geometry/heizkoerperLeistung', engineExport: 'bewerteDeckung' },
  ...
  { id: 'engine-abwasser', label: 'Abwasser-Gefälle', gruppe: 'sanitaer', art: 'engine', zustand: 'verfuegbar', funktion: 'Mindestgefälle DIN 1986-100', eingang: 'AbwasserEingabe', ausgang: 'AbwasserErgebnis', engineModul: 'geometry/abwassergefaelle', engineExport: 'pruefeAbwasser' },
  { id: 'engine-kueche', label: 'Küchen-Arbeitsdreieck', gruppe: 'kueche', art: 'engine', zustand: 'verfuegbar', funktion: 'Ergonomie DIN 18022', eingang: 'Arbeitsdreieck', ausgang: 'DreieckErgebnis', engineModul: 'geometry/kuecheArbeitsdreieck', engineExport: 'bewerteArbeitsdreieck' },
  { id: 'engine-pv', label: 'PV-Schnellbelegung', gruppe: 'energie-pv', art: 'engine', zustand: 'verfuegbar', funktion: 'Modulzahl, kWp, Flächennutzung', eingang: 'PvEingabe', ausgang: 'PvBelegung', engineModul: 'geometry/pvBelegung', engineExport: 'pvSchnellBelegung' },
  ...
  { id: 'engine-fensterprodukt', label: 'Fenster Uw / RC / Preis', gruppe: 'fenster-tuer', art: 'engine', zustand: 'verfuegbar', funktion: 'Uw (ISO 10077), RC (EN 1627), Preis', eingang: 'UwEingabe', ausgang: 'UwErgebnis', engineModul: 'geometry/fensterProdukt', engineExport: 'berechneUw' },
  { id: 'engine-sparren', label: 'Sparren-Vorbemessung', gruppe: 'dach-zimmerei', art: 'engine', zustand: 'verfuegbar', funktion: 'Biegenachweis Eurocode 5', eingang: 'SparrenEingabe', ausgang: 'SparrenErgebnis', engineModul: 'geometry/sparrenBerechnung', engineExport: 'berechneSparren' },
