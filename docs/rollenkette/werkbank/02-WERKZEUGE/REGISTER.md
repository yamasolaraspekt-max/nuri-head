...
| W-37 | **Rechenpanels (Engine-Flächen)** | LEER | N-001…N-003 | **N-003** — `app/EngineFlaeche.tsx` (**199 Z**, ~~196 Z~~ berichtigt 13.08. mit W-37) + `app/dashboard/enginePanels.ts`; trägt die **A-14**-Ausgabeauflage |
