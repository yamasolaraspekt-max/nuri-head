...
| W-16 | Grundriss unterlegen | **BESCHRIEBEN** | W-12 | F-032 · **Reifegrad nachgezogen 14.08. mit W-16/1** (~~LEER~~ → BESCHRIEBEN): alle **sieben** Blätter gefüllt, Legende `:6-8`. *Der Gegenstand hat ZWEI Hälften — drei Insel-Module UND Controller, Modell, sechs Routen `energie.plan-upload.*`, zwei Migrationen. Die Speicherung liegt NICHT in der Insel.* |
