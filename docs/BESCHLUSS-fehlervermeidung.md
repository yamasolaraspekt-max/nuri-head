...
| **B2** | **Der Validator meldet am Ende, was er AUSGEFÜHRT hat** — nicht nur, was fehlschlug. Eine Zeile: `N Befehle ausgefuehrt` | **4** | die Zeile steht im Bericht | Generator, offen |
