...
| **W-07N** `2-FUNKTION` + Azimutgrenze | **`CODE_FERTIG`**  | **Evaluator** (gebaut vom Planner in Generator-Rolle, Yamas Freigabe) | Schnitt `1734aa3b` · Basis `3d368625` | Nachbesserung §12.5 · 9 Platzhalter in `2-FUNKTION` gemessen · **schließt W-07 auf BESCHRIEBEN** · **KLASSE A ZU: Zähler 11/11** · drei Blätter statt eines (SPEC-Fehler war meiner) |
