...
naechster_schritt: "Frische Generator-Instanz zieht A-05 als Messlauf (vier Fragen, Bericht nach docs/BERICHT-A-05-l-kontur.md, KEINE Aenderung in resources/app/tests); A-07 bleibt VOR A-05 in der Bauschlange fuer Tor-Arbeit — die beiden beruehren sich nicht"
```
---
