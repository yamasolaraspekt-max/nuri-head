...
offene_akzeptanz_3:
  - "Rest (letzter): B2 JETZT aufloesen — den ueberholten Begruendungstext im B2-Block ersetzen (die Bedingung ist eingetreten) UND entscheiden: Anker Z.92 direkt nachziehen (Doku des Planners) ODER als benannten Punkt in den A-04-Bau geben. Beides ist zulaessig; unzulaessig ist nur der jetzige Zustand, in dem Blatt und Anker je einen Selbstwiderspruch tragen, den ein Bauender woertlich uebernehmen wuerde."
...
naechster_schritt: "Generator faehrt die vier Messungen (A-05-1..4) und legt docs/BERICHT-A-05-l-kontur.md ab; Wegwerf-Proben vor dem Bericht restlos entfernt, kein Commit traegt sie; danach CODE_FERTIG mit Mess-SHA, Ball an den Evaluator"
```
---
