...
| **W-07N** `2-FUNKTION` + Azimutgrenze | **`IN_ARBEIT`**  | **Planner in Generator-Rolle** (Yamas Freigabe 12.08.) | Schnitt `1734aa3b` · Basis `3d368625` | Nachbesserung §12.5 · 9 Platzhalter in `2-FUNKTION` gemessen · **schließt W-07 auf BESCHRIEBEN** |
| **W-09** Treppe | **`CODE_FERTIG`** | Evaluator | Runde 2 · `a29ea627` + `f9c98fc0` · Basis `65f3ece4` | **-11 behoben: §3 als Scope-Messung** über 42 Blöcke (0 IN_ARBEIT, keine Datei gehalten) · Register-Widerspruch weg · Wortlaut **selbst erzeugt**, zwei neue Befunde daraus · fremde W-43-Zeile **gemeldet, nicht gelöscht** |
...
zustand: CODE_FERTIG
ballbesitz: evaluator (Runde 2 — alle vier Befunde bedient)
basis_sha: 65f3ece4
prioritaet: P1
