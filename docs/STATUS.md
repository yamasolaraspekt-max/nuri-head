...
## A-08 — UMGESCHNITTEN auf die 0-Byte-Fassung (P0 bleibt; Ball beim Plan-Pruefer fuer die 2. DoR-Runde)
...
naechster_schritt: "Generator baut A-08 in der 0-Byte-Fassung (Katalog: Nachtrag 1-8 + 9/10 aus der verbindlichen Lesart, Nachtrag-Wortlaut fuehrt), setzt IN_ARBEIT VOR der ersten Scope-Aenderung, Bericht nach §11"
```
---
