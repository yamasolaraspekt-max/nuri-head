...
| **A-14** N-003-Vorbehalt ins Ergebnis | **`ABGENOMMEN`** | Release-Prüfer | Abnahme `21940d33` (Bau `e0722979`) · Elter `efca1899` · Basis `1e09280d` | **9/9 selbst nachgemessen** · Suite Bau 1693/1693, Elter 1692/1692 · Bündel byte-gleich nachgebaut · zwei Mutationen, beide gefangen · Browser 1440/1024/375: Sparren ohne Plakette, Treppe + FBH + Abwasser mit · Vorbehalt y=532 unter den Ausnutzungen y=429/506, gleiche Spalte x=728 · §3-Beleg 13 min vor der ersten Änderung · **ein SPEC-Punkt beim Planner (Engine-Zahl), blockiert nicht (§12.5)** |
