...
| **W-21** Sparren und Lattung | **`IN_ARBEIT`** | **Generator** | BEREIT `c9325929` | fünf Module, 496 Zeilen, 25 Ausfuhren, **Eurocode-Vorbemessung** · §7 8/8 · §3 beide Orte 0 · rot an der Basis: **34 Treffer** · **Tafelzeile von mir nachgetragen** |
...
zustand: IN_ARBEIT
ballbesitz: generator (Bau laeuft, Runde 2 zweites Blatt)
basis_sha: c9325929
