...
| Nr | Befund | |
|---|---|---|
| **Z-2** | **„Sparrenlänge" bezeichnet zwei verschiedene Hölzer.** `sparrenBerechnung.ts:137` liefert die **Systemlänge** Traufe–First (5/cos 38 = 6,345 m), `dachformVorlagen.ts:299` die **Zuschnittlänge** mit Überstand (5,5/cos 38 = 6,980 m). Wer „Sparrenlänge 6,35 m" liest und abbindet, schneidet zweimal den Überstand zu kurz | ○ |
