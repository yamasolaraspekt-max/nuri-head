...
| 6 | **Montage/Doku** | ~3 | Planner = Feld-Wahrheit; **Weiche-6-Rückfluss Feld→Büro MIT PL-Prüfschritt IST gebaut** (Korrektur: 02.07.-Migrationen + Qualifikations-Gate); Progressbar Weg A verifiziert; Report-Mirror+Historie | **FollowUpCreator NICHT am Feld-Abschluss**; **Aufmaß→Heizlast NICHT durchgereicht**; Checklisten-Smartrouting tot (0 Aufrufer+0 Regeln); kein gebuchter Tagesbericht |
...
*(Vollausgabe je Bereich in den 10 Dateien — Inventur 10/10 vollständig.)*

**Nachtrag Montage-Korrektur:** Der Feld→Büro-Rückfluss mit PL-Prüfschritt ist bereits gebaut (nicht mehr offen wie in älteren Docs) — firsthand am Schema gegengeprüft.
