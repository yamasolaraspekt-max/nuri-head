# PRÜFER-BEFUNDE — ARCHIV bis 03.08.2026 (Kipp 1)

> Ausgelagert nach PB-042 (b). Die lebende Tabelle und die offenen Befunde stehen in
> [`PRUEFER-BEFUNDE.md`](PRUEFER-BEFUNDE.md). Hier: die Runden-Protokolle und jeder
> geschlossene Befund im vollen Wortlaut. NICHTS wurde gelöscht, nur verschoben.
