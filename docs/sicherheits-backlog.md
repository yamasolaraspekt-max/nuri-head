...
**S-1 gesamt (Deal-Measurement-Ownership) ✅ funktional komplett** (S-1a write + S-1b-1 W-0/Notizen/Bilder + S-1b-2 Abilities). Offen: Umschalt auf hartes Deny (M5), Image-Präzisions-Weiche, `@index`-Write-on-read (S-2).
