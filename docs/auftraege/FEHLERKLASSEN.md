...
| **F-04** | **Zahl oder Artefakt behauptet statt gemessen** — ein Auftrag nennt eine Datei, Zusage oder Zahl, die niemand geprüft hat | **4** | 29.07. 21:30 | **R11** — jedes Kriterium trägt den Befehl, der es belegt, **und der Planner hat ihn gefahren**, bevor das Blatt liegt · **4. Auspraegung 29.07. 21:30:** die Grundgesamtheit von T3 (13 Bedienelemente) stammte aus der Inventur vom **25.07.** und war beim Schreiben des Blattes vier Tage alt — AUF-43 hatte zwei der drei P1 laengst erfuellt. **Gemeldet hat es der Generator, nicht ich** | ⚠ Regel, keine Barriere — `scripts/auftrag-pruefen.sh` steht aus |
