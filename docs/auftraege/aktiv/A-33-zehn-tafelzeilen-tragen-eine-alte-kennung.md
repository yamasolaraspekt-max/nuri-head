# A-33 — Zehn Tafelzeilen tragen die Kennung verkürzt, und deshalb prüft die Ball-Drift-Barriere sie nicht

```yaml
auftrag: "A-33"
werkzeug: "—  (Statuswahrheit in docs/STATUS.md)"
art: "BAU — zehn Tafelzeilen auf die Kennung ihres Datensatzes ziehen. Reine Datenberichtigung,
      kein Code."
spur: A
heimat_app: ticket
...
## 1 — Der Befund: zehn Zeilen, und die Barriere paart sie nicht
...
DIE NEUEREN ZEILEN SCHREIBEN BEIDES — Kennung MIT Suffix und Klartext:
  ...
  -> Vollstaendig UND lesbar. Die Verkuerzung bei den zehn alten spart also
...
> dass es keinen gibt** — die zehn alten tragen eine Konvention, die inzwischen abgelöst ist.*

## 4 — Scope

```text
A-33 IST  die ZEHN Tafelzeilen auf die Kennung ihres Datensatzes ziehen:
...
A-33 IST NICHT
          ...
          Alle zehn sind abgeschlossen (BETRIEBSBESTAETIGT oder ABGENOMMEN);
...
```text
A-33-1 (P1, TRAGEND) Nach dem Bau ist die Menge „Tafelzeile ohne Datensatz"
       genau EINS und heisst A-06. Nachweis mit Befehl und Rohausgabe, und das
       MUSTER wird vorher gegen eine FANGPROBE geprueft (Pruefung 7, fuenfter
       Schritt): mindestens zwei Faelle, die treffen muessen (Tafel mit und ohne
       Suffix), und einer, der NICHT treffen darf — `| **M-02-Kopienzahl** |`
       ist eine Zeile aus einer BEFUNDTABELLE und keine Auftragskennung. An
       genau dieser Stelle waere A-30 fast gescheitert.
...
A-33-3 (P1) KEIN Zustand und KEIN Ballbesitz geaendert. Gegenprobe: fuer jede
       der zehn Zeilen ist das Statusfeld vor und nach dem Bau zeichengleich.
       Rohausgabe je Zeile.
...
```yaml
warum_das_ueberhaupt_zaehlt_obwohl_alle_zehn_abgeschlossen_sind: "Der Nutzen ist NICHT, eine Ball-Drift
