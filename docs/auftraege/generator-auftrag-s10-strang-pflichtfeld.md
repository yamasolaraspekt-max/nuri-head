...
scope:
  population_command: "grep -rLn 'strang:' docs/auftraege/*.md | wc -l"
  pfade:
...
kriterien:
  - id: K-01
    ...
    kritikalitaet: P1
    pruefung:
      befehl: "node scripts/auftrag-pruefen.mjs <testblatt-ohne-strang>"
  ...
  - id: K-02
    ...
    kritikalitaet: P1
    pruefung:
      befehl: "node scripts/auftrag-pruefen.mjs <testblatt-mit-strang-quatsch>"
      erwartet: "Ausgabe enthaelt 'S-10', exit != 0"
    beleg: rohausgabe
  ...
  - id: K-03
    ...
    kritikalitaet: P1
    pruefung:
      befehl: "node scripts/auftrag-pruefen.mjs docs/product-data/15-auftrag-li-sv.md"
      erwartet: "Ausgabe enthaelt kein 'S-10'"
    beleg: rohausgabe

  - id: K-04
    aussage: "Die Regel wird beim Verzeichnislauf angewandt, nicht nur bei Einzelblaettern."
    typ: coverage
    kritikalitaet: P1
    pruefung:
      befehl: "node scripts/auftrag-pruefen.mjs docs/auftraege/"
      erwartet: "Anzahl S-10-Befunde == Anzahl Blaetter ohne gueltigen strang (population_command)"
    beleg: zaehlausgabe
  ...
  - id: K-05
    ...
    kritikalitaet: P1
    pruefung:
      befehl: "node scripts/auftrag-pruefen.mjs docs/auftraege/ (vorher/nachher, S-01..S-09 vergleichen)"
      erwartet: "identische Befundmenge fuer S-01 bis S-09"
    beleg: diff-der-beiden-laeufe

selbstnachweis:
  preflight: "./scripts/auftrag-pruefen.sh docs/auftraege/generator-auftrag-s10-strang-pflichtfeld.md"
