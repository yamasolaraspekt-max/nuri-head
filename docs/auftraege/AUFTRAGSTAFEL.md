...
**10** Arbeitsvorrat · **3** Abnahme · **11** bei Yama · **15** im Archiv — Summe geprüft, 39.
...
**Drei Posten — nicht zehn.** Der Evaluator hat abgetragen; was hier steht, ist der echte Rest:
**AUF-27** hängt an **AUF-37** (ohne Bundle-Rebuild keine Sichtprobe, §8 in
`docs/agents/06-laufzeiten-und-takt.md`), **AUF-21/I1** ist der einzige Teil des Icon-Pakets ohne Votum,
**AUF-30** hat als einziger Posten überhaupt noch keine Prüfung. Niemand nimmt eigene Arbeit ab (§1.4).
...
Abgenommen oder entfallen, wortgleich in **`docs/auftraege/AUFTRAGSTAFEL-ARCHIV.md`** — **15 Posten**:
AUF-1 · AUF-2 · AUF-3 · AUF-4 · AUF-9 · AUF-12 · AUF-15a · AUF-16 · AUF-19 · AUF-20 · AUF-24 · AUF-25 ·
AUF-26 · AUF-31 · AUF-32. Nicht gelöscht, nur nicht mehr im Weg.
