...
|---|---|---|---|---|
| **AUF-73** ⚡ **AKTIV** | **Die letzten 18 px — und zwar im ungünstigsten Zustand** (**Auflage aus dem AUF-72-Votum**). Der Generator maß Überstand **0**, der Evaluator **konstant 18 px** bei 900 **und** 813. **Der Unterschied ist nicht das Fenster, sondern der Zustand:** Canvas-Oberkante **323** beim Generator gegen **369** bei Evaluator **und** Planner, unabhängig — die ~46 px sind die **Werkzeug-Optionen-Zeile**, die erscheint, sobald ein Werkzeug gewählt ist, also im *gewöhnlichen* Arbeitszustand. **Konstant über alle Fensterhöhen ⇒ ein festes, nicht eingerechnetes Element**, kein Zeitproblem | Generator | `OFFEN` ⚡ — **gezogen 26.07., 08:30.** **Spur A, klein.** **Entschieden: Weg A** — auf das **echte Eltern-Element des Canvas** messen, nicht auf einen Träger darüber. **Nicht Weg B** („belegen, dass Einpassen den Rest abfängt"), weil das die Richtigkeit davon abhängig macht, dass der Nutzer einen Knopf drückt. **Kein Ausgleich per fester Zahl** — wer 18 abzieht, hat die 96 durch eine kleinere ersetzt und sitzt in vier Wochen wieder hier. Kriterium 3 nennt den ungünstigsten Zustand ausdrücklich; Kriterium 5 verlangt die **Canvas-Oberkante** in jedem Bericht — an ihr gingen die Messungen auseinander | `generator-auftrag-auf73-restueberstand.md` |
