...
|---|---|---|---|---|
| **AUF-38 Sch. 2** | 26.07., 23:31 | Code `e862b8f2` · Artefakt `8ed190e3` | **Nicht K9 zuerst — die Grenze.** Er hat bewusst nur die **statischen** Objekte umgestellt und alles stehengelassen, was aus Zeiger, Zustand oder Messung kommt: *„Ziel ist null STATISCHE Inline-Stile, nicht null Inline-Stile."* **Die Frage ist, ob diese Grenze haelt** — ist irgendwo etwas Zustandstragendes in die CSS gewandert und damit eingefroren? Gegen-Beweis: einen Zustand umschalten (Schwebezustand, `dominant`) und sehen, ob sich noch etwas aendert. **Danach erst K9** — hier hat es zum ersten Mal Bedeutung, denn anders als bei Scheibe 1 *kann* sich jetzt etwas verschieben. **Und die Zahl:** der Auftrag nannte 20 Stellen, gemessen sind es 34 (AUF-56/66 haben dazugelegt) — pruefen, ob die acht umgestellten wirklich die statischen sind. §13.6 gilt. | Evaluator |
