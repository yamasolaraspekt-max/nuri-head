...
| **AUF-4** | **Wizard-Welle A2** — Leiste liest die Präsentationsschicht, inkl. P9-Memoisierung | Generator | `BERICHTET — wartet auf Evaluator` (Commit `acdb987`) — umgesetzt 25.07. Das ist **L1** aus `fahrplan-frontend-layout-hausplaner.md` und der Engpass des gesamten Layouts. Die vier A1-Auflagen sind mit umzusetzen | `generator-auftrag-wizard-welle-a2-leiste-liest-praesentation.md` **inkl. §8** |
