...
|---|---|---|---|---|
| **AUF-57** ⚡ **AKTIV** | **Der Wegweiser braucht einen Anlass und einen Ort** (Rückgabe des Generators aus AUF-45) — der Mechanismus ist gebaut, gemessen und verriegelt, **erscheint aber nie**: `activeLevel.exists` ist nie verletzt, weil eine Szene immer mindestens ein Geschoss trägt. **Die Zahlen meines Auftrags waren überholt** (78/44/16 stammten aus der Zeit vor AUF-34; gemessen sind es 73/53/28). Der real größte Block sind **28 Werkzeuge, die einem anderen Arbeitsbereich gehören** — nicht das Geschoss. Der Planner entscheidet Anlass und Ort; Vorschlag: ein Hinweis am Arbeitsbereich-Wähler, der die messbare Zahl nennt, statt eines globalen ersten Schritts | Planner → Generator | `IN ARBEIT — Generator (nativ)` — gezogen 26.07. | `generator-auftrag-auf57-wegweiser-ort.md` |
