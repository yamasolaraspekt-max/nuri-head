...
| **AUF-78** | 26.07., 16:38 | Code `841865b` · Bundle `dcbe6ec` | **Das Rechtegatter.** Der Generator hat die Middleware **gemessen** statt „unveraendert" zu behaupten, und K11 haelt: Liste an die Studio-Flaeche gehaengt ⇒ **2 Tests rot** (Verhalten *und* Quelltext). Dazu: **keine Kundendaten** (Beziehung gar nicht geladen), vier Felder, harte Grenze 6, `public/*` im Code-Commit **0**. **Rueckgabe:** der Klick auf eine Kachel ist bewusst **nicht** verdrahtet | Evaluator |
