...
|---|---|---|---|---|
| **AUF-39** ⚡ **AKTIV** | **L5 — Wizard-Schritte aus dem Modell ableiten** statt hartkodierter Status/Prüfungen. Steht seit `5af3e18` im Layout-Fahrplan und hatte bis 25.07. **keinen Posten** — gemessen: null Treffer auf `L5` in dieser Tafel. Guardrail aus dem Fahrplan: an vorhandene Services andocken, **kein zweiter Snapshot-/Hash-/Projektions-Mechanismus** | Planner → Generator | `OFFEN` ⚡ — **AKTIV.** Auftrag liegt. Kernkriterium: **leeres Dokument ⇒ kein grüner Schritt**. Belegt durch die Sichtprobe: „5 Räume erkannt" steht neben „Im Modell: 0 Fenster · 0 Türen" | `generator-auftrag-auf39-wizard-schritte.md` |
