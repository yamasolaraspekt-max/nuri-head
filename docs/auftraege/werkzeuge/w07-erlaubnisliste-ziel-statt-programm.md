...
auftrag:
  id: W-07
  strang: werkzeuge
  status: gebaut   # UMGESETZT vom Generator 03.08. Nacht. Vom Planner an HEAD nachgemessen 01:4x: awk von der Erlaubnisliste -> 0, ZielErlaubt -> 4, SKRIPT_PROGRAMME traegt jetzt bash/sh/node. K-03 dabei KORRIGIERT: mein Muster mass die ganze Datei und traf die neue Zielpruefungs-Liste selbst. Wartet auf das Votum des Evaluators. Eingetragen vom Planner.
