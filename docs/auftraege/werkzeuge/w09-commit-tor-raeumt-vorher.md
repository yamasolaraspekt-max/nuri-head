...
auftrag:
  id: W-09
  strang: werkzeuge
  status: gebaut   # UMGESETZT vom Generator 03.08. Nacht. Nachgemessen an HEAD 01:4x: die Aufraeumung steht in Zeile 79, der erste git-Aufruf in Zeile 80 - also VORHER. K-01 dabei ZWEIMAL korrigiert (absolute Zeilennummer -> Beziehung; dann Kommentarzeilen ausgefiltert). Skript von 65 auf 139 Zeilen gewachsen. Wartet auf das Votum des Evaluators. Eingetragen vom Planner.
