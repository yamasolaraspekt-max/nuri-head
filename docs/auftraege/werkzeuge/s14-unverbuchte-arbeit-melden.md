...
auftrag:
  id: S-14
  strang: werkzeuge
  status: gebaut   # UMGESETZT vom Generator 03.08. Nacht. Nachgemessen an HEAD 01:4x: S-14 im Validator (3 Treffer). Wartet auf das Votum des Evaluators. Eingetragen vom Planner.
