...
use App\Models\PowerOptimizer;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use Illuminate\Support\Facades\Log;


class PowerOptimizerController extends Controller
{
    /**
    ...
    public function load(Request $request)
    {
        ...
        $data = PowerOptimizer::where('product_id', $product_id)
   ...
   public function store(Request $request)
    {
        ...
        try {
            $powerOptimizer = PowerOptimizer::updateOrCreate(
     ...
     */
    public function show(PowerOptimizer $powerOptimizer)
    {
        //
    }
     ...
     */
    public function edit(PowerOptimizer $powerOptimizer)
    {
        //
    }
     ...
     */
    public function update(Request $request, PowerOptimizer $powerOptimizer)
    {
        //
    }
     ...
     */
    public function destroy(PowerOptimizer $powerOptimizer)
    {
        //
    }
}
